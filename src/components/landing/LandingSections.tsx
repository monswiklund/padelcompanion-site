...
export const SponsorSlot: React.FC = () => (
  <motion.a
    ...
    whileTap={{ scale: 0.98 }}
    className="h-[100px] bg-white/[0.02] border border-dashed border-white/10 rounded-2xl flex items-center justify-center text-muted-foreground/30 text-sm hover:text-muted-foreground hover:border-white/20 transition-all"
  >
