      ...
      <div className="max-w-3xl mx-auto px-6">
        <article className="prose prose-invert">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside text-muted-foreground space-y-2">
              <li>
                <strong className="text-foreground">Google Firebase:</strong> For
                authentication, database (Firestore), cloud functions, and
                analytics.
              </li>
              <li>
                <strong className="text-foreground">RevenueCat:</strong> For
                managing in-app subscriptions and purchases.
              </li>
              <li>
                <strong className="text-foreground">Simple Analytics:</strong> For
