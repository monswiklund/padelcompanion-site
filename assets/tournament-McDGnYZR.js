import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              */const n={players:[],format:"americano",courts:2,scoringMode:"total",pointsPerMatch:24,rankingCriteria:"points",courtFormat:"court",customCourtNames:[],maxRepeats:99,pairingStrategy:"optimal",preferredPartners:[],manualByes:[],hideLeaderboard:!0,showPositionChanges:!0,gridColumns:0,textSize:100,isLocked:!1,schedule:[],currentRound:0,leaderboard:[],allRounds:null,maxCourts:2},V=[],je=20;function se(){const e=JSON.parse(JSON.stringify(n));V.push(e),V.length>je&&V.shift()}function Ue(){if(V.length===0)return!1;const e=V.pop();return Le(e),!0}function Ve(){return V.length>0}const Ee="tournament-state";function v(){localStorage.setItem(Ee,JSON.stringify({players:n.players,format:n.format,courts:n.courts,scoringMode:n.scoringMode,pointsPerMatch:n.pointsPerMatch,rankingCriteria:n.rankingCriteria,courtFormat:n.courtFormat,customCourtNames:n.customCourtNames,maxRepeats:n.maxRepeats,pairingStrategy:n.pairingStrategy,preferredPartners:n.preferredPartners,schedule:n.schedule,currentRound:n.currentRound,leaderboard:n.leaderboard,allRounds:n.allRounds,isLocked:n.isLocked,hideLeaderboard:n.hideLeaderboard,manualByes:n.manualByes,gridColumns:n.gridColumns,textSize:n.textSize}))}function Ye(){const e=localStorage.getItem(Ee);if(!e)return!1;try{const t=JSON.parse(e);return n.players=Array.isArray(t.players)?t.players.slice(0,200):[],n.format=t.format||"americano",n.courts=Math.max(1,Math.min(50,t.courts||2)),n.scoringMode=t.scoringMode||"total",n.pointsPerMatch=Math.max(1,Math.min(999,t.pointsPerMatch||24)),n.rankingCriteria=t.rankingCriteria||"points",n.courtFormat=t.courtFormat||"court",n.customCourtNames=Array.isArray(t.customCourtNames)?t.customCourtNames.slice(0,50):[],n.maxRepeats=Math.max(0,Math.min(99,t.maxRepeats!==void 0?t.maxRepeats:99)),n.pairingStrategy=t.pairingStrategy||"optimal",n.preferredPartners=Array.isArray(t.preferredPartners)?t.preferredPartners.slice(0,100):[],n.schedule=Array.isArray(t.schedule)?t.schedule:[],n.currentRound=Math.max(0,Math.min(100,t.currentRound||0)),n.leaderboard=Array.isArray(t.leaderboard)?t.leaderboard:[],n.allRounds=t.allRounds||null,n.isLocked=t.isLocked||!1,n.hideLeaderboard=t.hideLeaderboard!==void 0?t.hideLeaderboard:!0,n.manualByes=Array.isArray(t.manualByes)?t.manualByes:[],n.gridColumns=Math.max(0,Math.min(10,t.gridColumns||0)),n.textSize=Math.max(50,Math.min(200,t.textSize||100)),!0}catch(t){return console.error("Failed to load tournament state:",t),!1}}function _e(){return JSON.parse(JSON.stringify(n))}function Le(e){e&&(Object.keys(n).forEach(t=>{e.hasOwnProperty(t)&&(n[t]=e[t])}),n.players=n.players||[],n.schedule=n.schedule||[],n.leaderboard=n.leaderboard||[],v())}function te(e){for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}function b(e,t=3e3){const s=document.querySelector(".toast");s&&s.remove();const o=document.createElement("div");o.className="toast",o.textContent=e,document.body.appendChild(o),setTimeout(()=>o.classList.add("visible"),10),setTimeout(()=>{o.classList.remove("visible"),setTimeout(()=>o.remove(),300)},t)}function ae(){return Date.now()+Math.random()}let x,M,N,F,Y=[],ce,J=!1;const Se=["#f44336","#e91e63","#9c27b0","#673ab7","#3f51b5","#2196f3","#03a9f4","#00bcd4","#009688","#4caf50","#8bc34a","#cddc39","#ffeb3b","#ffc107","#ff9800","#ff5722"];function Ce(e,t){return Math.floor(Math.random()*(t-e+1)+e)}function Ge(){this.x=Math.random()*N,this.y=Math.random()*F-F,this.r=Ce(10,30),this.d=Math.random()*150+10,this.color=Se[Ce(0,Se.length-1)],this.tilt=Math.floor(Math.random()*10)-10,this.tiltAngleIncremental=Math.random()*.07+.05,this.tiltAngle=0,this.draw=function(){return M.beginPath(),M.lineWidth=this.r/2,M.strokeStyle=this.color,M.moveTo(this.x+this.tilt+this.r/4,this.y),M.lineTo(this.x+this.tilt,this.y+this.tilt+this.r/4),M.stroke()}}function Pe(){if(J){M.clearRect(0,0,N,F);for(let e=0;e<Y.length;e++)Y[e].draw();Xe(),ce=requestAnimationFrame(Pe)}}function Xe(){for(let e=0;e<Y.length;e++){const t=Y[e];t.tiltAngle+=t.tiltAngleIncremental,t.y+=(Math.cos(t.d)+3+t.r/2)/2,t.tilt=Math.sin(t.tiltAngle-e/3)*15,(t.x>N+20||t.x<-20||t.y>F)&&J&&(t.x=Math.random()*N,t.y=-10,t.tilt=Math.floor(Math.random()*10)-10)}}function Je(){if(!J){x||(x=document.createElement("canvas"),x.id="confetti-canvas",x.style.position="fixed",x.style.top="0",x.style.left="0",x.style.width="100%",x.style.height="100%",x.style.pointerEvents="none",x.style.zIndex="9999",document.body.appendChild(x),M=x.getContext("2d")),N=window.innerWidth,F=window.innerHeight,x.width=N,x.height=F,window.addEventListener("resize",()=>{N=window.innerWidth,F=window.innerHeight,x.width=N,x.height=F}),J=!0,Y=[];for(let e=0;e<150;e++)Y.push(new Ge);Pe()}}function Ke(){J=!1,M&&M.clearRect(0,0,N,F),ce&&cancelAnimationFrame(ce),x&&x.remove(),x=null}function Qe(){Je(),setTimeout(Ke,5e3)}function T(e,t,s="Confirm",o,r=!1,a=null,d=null){const l=document.querySelector(".confirm-modal");l&&l.remove();const i=document.createElement("div");i.className="modal-overlay confirm-modal",i.style.display="flex";const m=r?"btn btn-danger":"btn btn-primary";i.innerHTML=`
  ...
  `).join("")}function ct(e,t){n.customCourtNames[e]=t||`Court ${e+1}`,v()}function q(){const e=S();e.playerList.innerHTML=n.players.map((t,s)=>`
...
`})});const d=encodeURI(r),l=document.createElement("a");l.setAttribute("href",d),l.setAttribute("download",`padel_tournament_${new Date().toISOString().slice(0,10)}.csv`),document.body.appendChild(l),l.click(),document.body.removeChild(l)}async function Nt(e=null){var a;const t=e||n;let o=`Padel Tournament Results - ${new Date().toLocaleDateString()}
...
`}),o+=`
Full results: https://padelcompanion.se/tournament/`;try{await navigator.clipboard.writeText(o),b("Results copied to clipboard")}catch(d){console.error("Failed to copy: ",d),b("Failed to copy results","error")}}const pe="padel_history_v1";function Ft(){var o;const e=Z(),t=_e(),s={id:Date.now().toString(),savedAt:new Date().toISOString(),summary:{date:new Date().toISOString(),format:t.format,winner:((o=t.leaderboard[0])==null?void 0:o.name)||"Unknown",playerCount:t.players.length,roundCount:t.schedule.length},data:t};return e.unshift(s),e.length>20&&e.pop(),localStorage.setItem(pe,JSON.stringify(e)),s}function Z(){try{const e=localStorage.getItem(pe);return e?JSON.parse(e):[]}catch(e){return console.error("Failed to parse history",e),[]}}function Dt(e){T("Delete this tournament from history?","This action cannot be undone.","Delete",()=>{const s=Z().filter(o=>o.id!==e);localStorage.setItem(pe,JSON.stringify(s)),Fe(),b("Tournament deleted")},!0)}function zt(e){const s=Z().find(o=>o.id===e);if(!s){b("Tournament details not found","error");return}T("Load this tournament?","This will overwrite the current tournament.","Load",()=>{try{Le(s.data),z(),k(),v(),b("Tournament loaded successfully"),document.getElementById("scheduleSection").style.display="block",document.getElementById("leaderboardSection").style.display="block"}catch(o){console.error("Failed to load tournament",o),b("Error loading tournament","error")}},!1)}let oe=[];function Ht(){Fe();const e=document.getElementById("historySearch");e&&e.addEventListener("input",t=>{const s=t.target.value.toLowerCase();Ot(s)})}function Ot(e){if(!e){me(oe);return}const t=oe.filter(s=>{var u,c,y,f,h,p,w,R;const o=(((u=s.summary)==null?void 0:u.winner)||((y=(c=s.players)==null?void 0:c[0])==null?void 0:y.name)||"").toLowerCase(),r=(((f=s.summary)==null?void 0:f.format)||s.format||"").toLowerCase(),a=((h=s.summary)==null?void 0:h.date)||s.date||"",d=String(((p=s.summary)==null?void 0:p.playerCount)||((w=s.players)==null?void 0:w.length)||""),l=String(((R=s.summary)==null?void 0:R.roundCount)||""),m=new Date(a).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}).toLowerCase();return o.includes(e)||r.includes(e)||m.includes(e)||d.includes(e)||l.includes(e)});me(t)}function Fe(){oe=Z(),me(oe)}function me(e){const t=document.getElementById("historyTableBody"),s=document.getElementById("historyEmptyStatePage");if(!(!t||!s)){if(t.innerHTML="",e.length===0){t.parentElement.style.display="none",s.style.display="block";return}t.parentElement.style.display="table",s.style.display="none",window.deleteHistoryItem=Dt,window.loadTournament=zt,window.downloadHistoryItem=qt,t.innerHTML=e.map(o=>{var y,f,h;const r=o.summary?o.summary.date:o.date,a=o.summary?o.summary.format:o.format||"Unknown",d=o.summary?o.summary.winner:((f=(y=o.players)==null?void 0:y[0])==null?void 0:f.name)||"Unknown",l=o.summary?o.summary.playerCount:((h=o.players)==null?void 0:h.length)||0,i=new Date(r),m=i.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),u=i.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),c=!!o.data;return`
      <tr>
        <td>
      ...
      `}).join("")}}function qt(e){const s=Z().find(o=>o.id===e);s&&s.data&&window.exportTournamentData&&window.exportTournamentData(s.data)}document.addEventListener("DOMContentLoaded",()=>{});const De="padelcompanion-theme";function Wt(){const e=localStorage.getItem(De),t=!e||e==="dark";return document.documentElement.setAttribute("data-theme",t?"dark":"light"),t?"dark":"light"}function jt(){const t=document.documentElement.getAttribute("data-theme")==="dark"?"light":"dark";return document.documentElement.setAttribute("data-theme",t),localStorage.setItem(De,t),t}function ze(e,t){if(!e)return;const s=e.querySelector(".theme-icon");s&&(s.textContent=t==="dark"?"🌙":"☀️")}function Be(e){if(!e.trim())return!1;const t=e.trim();return n.players.length>=24?(b("Maximum 24 players allowed"),!1):n.players.some(s=>s.name.toLowerCase()===t.toLowerCase())?(b(`Player "${t}" already exists`),!1):(n.players.push({id:ae(),name:t,points:0,wins:0,losses:0,pointsLost:0,played:0}),v(),!0)}function Ut(e){n.players=n.players.filter(t=>t.id!==e),v()}function Vt(e){if(console.log("removeAllPlayers called, players:",n.players.length),n.players.length===0){console.log("No players to remove");return}T("Remove All Players?","Are you sure you want to clear the entire player list? This action cannot be undone.","Yes, Remove All",()=>{console.log("Confirm callback executed"),n.players=[],n.preferredPartners=[],v(),console.log("Players cleared, state:",n.players),e&&e()},!0)}function Yt(e){if(!e.trim())return{added:0,duplicates:0,hitLimit:!1};const t=e.split(/[\n,]+/).map(a=>a.trim()).filter(a=>a);if(t.length===0)return{added:0,duplicates:0,hitLimit:!1};let s=0,o=0,r=!1;for(const a of t){if(n.players.length>=24){r=!0;break}if(n.players.some(d=>d.name.toLowerCase()===a.toLowerCase())){o++;continue}n.players.push({id:ae(),name:a,points:0,wins:0,losses:0,pointsLost:0,played:0}),s++}return v(),{added:s,duplicates:o,hitLimit:r}}function _t(e){const t={id:ae(),name:e,points:0,wins:0,losses:0,played:0,pointsLost:0,byeCount:0,playedWith:[]};return n.players.push(t),n.leaderboard.push(t),v(),!0}function Gt(){const e=new Set;return n.preferredPartners.forEach(t=>{e.add(t.player1Id),e.add(t.player2Id)}),n.players.filter(t=>!e.has(t.id))}function Xt(){const e=Gt();e.length<2||(n.preferredPartners.push({id:ae(),player1Id:e[0].id,player2Id:e[1].id}),v())}function Jt(e){n.preferredPartners=n.preferredPartners.filter(t=>t.id!==e),v()}function Kt(e,t,s){const o=n.preferredPartners.find(r=>r.id===e);o&&(t===1?o.player1Id=s:o.player2Id=s,v())}function Qt(e){let t;const s=document.getElementById(e);window.addEventListener("beforeinstallprompt",o=>{o.preventDefault(),t=o,s&&(s.style.display="inline-flex",s.addEventListener("click",async()=>{s.style.display="none",t.prompt(),(await t.userChoice).outcome==="accepted"?console.log("User accepted the install prompt"):console.log("User dismissed the install prompt"),t=null}))}),window.addEventListener("appinstalled",()=>{s&&(s.style.display="none"),t=null,console.log("PWA was installed")}),"serviceWorker"in navigator&&window.addEventListener("load",()=>{navigator.serviceWorker.register("/registerSW.js")})}function Zt(){Qt("installBtn");const e=Wt(),t=Me();ze(t.themeToggle,e),Ye(),t.format.value=n.format,t.courts.value=n.courts,t.scoringMode.value=n.scoringMode,t.points.value=n.pointsPerMatch,t.courtFormat.value=n.courtFormat,t.maxRepeats.value=n.maxRepeats,t.pairingStrategy&&(t.pairingStrategy.value=n.pairingStrategy);const s=document.getElementById("strictStrategy");if(s&&(s.checked=n.strictStrategy||!1),ke(),q(),n.schedule.length>0){t.scheduleSection.style.display="block",t.leaderboardSection.style.display="block";const o=document.getElementById("tournamentActionsSection");o&&(o.style.display="block"),z(),k(),A(),Q()}en(t),Ht(),window.addEventListener("resize",Ae)}function en(e){e.themeToggle.addEventListener("click",()=>{const u=jt();ze(e.themeToggle,u)});const t=document.getElementById("navToggle"),s=document.getElementById("nav");t&&s&&(t.addEventListener("click",()=>{s.classList.toggle("open"),t.classList.toggle("active")}),document.addEventListener("click",u=>{s.classList.contains("open")&&!s.contains(u.target)&&!t.contains(u.target)&&(s.classList.remove("open"),t.classList.remove("active"))}),s.querySelectorAll("a").forEach(u=>{u.addEventListener("click",()=>{s.classList.remove("open"),t.classList.remove("active")})}));const o=document.getElementById("undoBtn");o&&(o.addEventListener("click",()=>{if(Ue())if(b("Undo successful"),e.format.value=n.format,q(),z(),k(),A(),Q(),n.schedule.length>0){e.scheduleSection.style.display="block",e.leaderboardSection.style.display="block";const u=document.getElementById("tournamentActionsSection");u&&(u.style.display="block")}else{e.scheduleSection.style.display="none",e.leaderboardSection.style.display="none";const u=document.getElementById("tournamentActionsSection");u&&(u.style.display="none")}}),document.addEventListener("keydown",u=>{(u.ctrlKey||u.metaKey)&&u.key==="z"&&!u.shiftKey&&(u.preventDefault(),o.click())})),e.addPlayerBtn.addEventListener("click",ut),e.cancelAddBtn.addEventListener("click",xe),e.clearAllPlayersBtn&&e.clearAllPlayersBtn.addEventListener("click",()=>{Vt(()=>{q(),K(),A()})}),e.importPlayersBtn.addEventListener("click",ft),e.closeImportModal.addEventListener("click",de),e.cancelImportBtn.addEventListener("click",de),e.confirmImportBtn.addEventListener("click",()=>{const u=e.importTextarea.value,c=Yt(u);let y=`Added ${c.added} players.`;c.duplicates>0&&(y+=` Skipped ${c.duplicates} duplicates.`),c.hitLimit&&(y+=" Stopped at 24 max limit."),e.importStatus.textContent=y,q(),c.added>0&&c.duplicates===0&&!c.hitLimit&&(setTimeout(de,1500),b(`Imported ${c.added} players`))}),e.confirmAddBtn.addEventListener("click",()=>{Be(e.playerNameInput.value)&&(e.playerNameInput.value="",e.playerNameInput.focus(),q())}),e.playerNameInput.addEventListener("keydown",u=>{u.key==="Enter"?Be(e.playerNameInput.value)&&(e.playerNameInput.value="",q()):u.key==="Escape"&&xe()}),e.format.addEventListener("change",()=>{n.format=e.format.value,A(),v()}),e.courts.addEventListener("change",()=>{n.courts=parseInt(e.courts.value),v()}),e.points.addEventListener("change",()=>{n.pointsPerMatch=parseInt(e.points.value),v()}),e.scoringMode.addEventListener("change",()=>{n.scoringMode=e.scoringMode.value,v()}),e.courtFormat.addEventListener("change",()=>{n.courtFormat=e.courtFormat.value,ke(),v()}),e.courts.addEventListener("input",()=>{const c=e.courts.value;if(c==="")return;let y=parseInt(c)||1;y=Math.max(1,Math.min(50,y)),e.courts.value=y,n.courts=y,v(),n.courtFormat==="custom"&&Re()}),e.maxRepeats.addEventListener("change",u=>{const c=parseInt(u.target.value),y=n.maxRepeats;n.isLocked?(u.target.value=y,T("Change Matchup Setting?","The tournament is running. This change will affect how future rounds are generated.","Apply Change",()=>{n.maxRepeats=c,e.maxRepeats.value=c,v(),b("Max Partner Repeats updated")})):(n.maxRepeats=c,v())});const r=document.getElementById("strictStrategy");r&&r.addEventListener("change",u=>{const c=u.target.checked,y=n.strictStrategy;n.isLocked?(u.target.checked=!!y,T("Update Strict Mode?","The tournament is running. This change will affect how future rounds are generated.","Apply Change",()=>{n.strictStrategy=c,r.checked=c,v(),b("Strict Mode updated")})):(n.strictStrategy=c,v())}),e.pairingStrategy&&e.pairingStrategy.addEventListener("change",u=>{const c=u.target.value,y=n.pairingStrategy;n.isLocked?(u.target.value=y,T("Change Matchup Setting?","The tournament is running. This change will affect how future rounds are generated.","Apply Change",()=>{n.pairingStrategy=c,e.pairingStrategy.value=c,v(),A(),b("Pairing Strategy updated")})):(n.pairingStrategy=c,v(),A())}),e.addPartnerPairBtn.addEventListener("click",()=>{Xt(),K()});const a=document.getElementById("helpFormat");a&&a.addEventListener("click",()=>{le("Tournament Formats",`
        ...
        `)}),e.generateBtn.addEventListener("click",Lt),e.printBtn.addEventListener("click",()=>window.print()),e.resetBtn.addEventListener("click",Pt),e.gridColumns&&e.gridColumns.addEventListener("input",bt),e.textSize&&e.textSize.addEventListener("input",()=>{n.textSize=parseInt(e.textSize.value),Ne(),v()});const i=document.getElementById("factoryResetBtn");i&&i.addEventListener("click",()=>{T("⚠️ Factory Reset","This will clear the current tournament and reset the app. Your saved history will NOT be deleted. Are you sure?","Yes, Reset App",()=>{localStorage.removeItem("tournament-state"),window.location.reload()},!0)});const m=document.getElementById("roundScale");m&&m.addEventListener("input",wt)}window.removePlayer=e=>{Ut(e),q()};window.togglePlayerList=mt;window.updatePreferredPair=(e,t,s)=>{Kt(e,t,s),K()};window.removePreferredPair=e=>{Jt(e),K()};window.updateCustomCourtName=ct;window.autoFillScore=St;window.toggleManualBye=xt;window.toggleRoundCollapse=Ct;window.completeRound=Bt;window.editRound=Et;window.toggleLeaderboardVisibility=$t;window.togglePositionChanges=It;window.updateRankingCriteria=Mt;window.endTournament=()=>Tt(Ze);window.validateCourts=Te;window.toggleAdvancedSettings=kt;window.toggleToolbar=Rt;window.exportTournamentData=At;window.shareResults=Nt;console.log("Global functions registered:",{autoFillScore:typeof window.autoFillScore,validateCourts:typeof window.validateCourts});window.promptAddLatePlayer=()=>{const e=n.format==="team"||n.format==="teamMexicano";$e(e?"Add Late Team":"Add Late Player",e?"Enter new team name:":"Enter new player name:",t=>{if(t&&t.trim()){if(n.format==="americano"||n.format==="team"){if(!confirm("Adding a player/team mid-tournament will switch the remaining rounds to Mexicano (Dynamic) logic to accommodate the change. Continue?"))return;n.format="mexicano",n.allRounds=null,b("Switched to Mexicano format")}_t(t.trim());const s=document.getElementById("playerCount");s&&(s.textContent=`(${n.players.length})`),k(),b(`Added ${t.trim()} to tournament`)}})};Zt();
