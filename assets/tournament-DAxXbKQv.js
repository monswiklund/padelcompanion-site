import{i as It,a as $t}from"./layout-Bam87DKj.js";const n={players:[],format:"americano",courts:2,scoringMode:"total",pointsPerMatch:24,rankingCriteria:"points",courtFormat:"court",customCourtNames:[],maxRepeats:99,pairingStrategy:"optimal",preferredPartners:[],manualByes:[],hideLeaderboard:!0,showPositionChanges:!0,gridColumns:0,textSize:100,isLocked:!1,schedule:[],currentRound:0,leaderboard:[],allRounds:null,maxCourts:2},Z=[],kt=20;function De(){const e=document.getElementById("undoBtn");e&&(e.disabled=Z.length===0)}function pe(){const e=JSON.parse(JSON.stringify(n));Z.push(e),Z.length>kt&&Z.shift(),De()}function Pt(){if(Z.length===0)return!1;const e=Z.pop();return Oe(e),De(),!0}const He="tournament-state";function S(){localStorage.setItem(He,JSON.stringify({players:n.players,format:n.format,courts:n.courts,scoringMode:n.scoringMode,pointsPerMatch:n.pointsPerMatch,rankingCriteria:n.rankingCriteria,courtFormat:n.courtFormat,customCourtNames:n.customCourtNames,maxRepeats:n.maxRepeats,pairingStrategy:n.pairingStrategy,preferredPartners:n.preferredPartners,schedule:n.schedule,currentRound:n.currentRound,leaderboard:n.leaderboard,allRounds:n.allRounds,isLocked:n.isLocked,hideLeaderboard:n.hideLeaderboard,manualByes:n.manualByes,gridColumns:n.gridColumns,textSize:n.textSize}))}function Bt(){const e=localStorage.getItem(He);if(!e)return!1;try{const t=JSON.parse(e);return n.players=Array.isArray(t.players)?t.players.slice(0,200):[],n.format=t.format||"americano",n.courts=Math.max(1,Math.min(50,t.courts||2)),n.scoringMode=t.scoringMode||"total",n.pointsPerMatch=Math.max(1,Math.min(999,t.pointsPerMatch||24)),n.rankingCriteria=t.rankingCriteria||"points",n.courtFormat=t.courtFormat||"court",n.customCourtNames=Array.isArray(t.customCourtNames)?t.customCourtNames.slice(0,50):[],n.maxRepeats=Math.max(0,Math.min(99,t.maxRepeats!==void 0?t.maxRepeats:99)),n.pairingStrategy=t.pairingStrategy||"optimal",n.preferredPartners=Array.isArray(t.preferredPartners)?t.preferredPartners.slice(0,100):[],n.schedule=Array.isArray(t.schedule)?t.schedule:[],n.currentRound=Math.max(0,Math.min(100,t.currentRound||0)),n.leaderboard=Array.isArray(t.leaderboard)?t.leaderboard:[],n.allRounds=t.allRounds||null,n.isLocked=t.isLocked||!1,n.hideLeaderboard=t.hideLeaderboard!==void 0?t.hideLeaderboard:!0,n.manualByes=Array.isArray(t.manualByes)?t.manualByes:[],n.gridColumns=Math.max(0,Math.min(10,t.gridColumns||0)),n.textSize=Math.max(50,Math.min(200,t.textSize||100)),!0}catch(t){return console.error("Failed to load tournament state:",t),!1}}function Mt(){return JSON.parse(JSON.stringify(n))}function Oe(e){e&&(Object.keys(n).forEach(t=>{e.hasOwnProperty(t)&&(n[t]=e[t])}),n.players=n.players||[],n.schedule=n.schedule||[],n.leaderboard=n.leaderboard||[],S())}function le(e){for(let t=e.length-1;t>0;t--){const o=Math.floor(Math.random()*(t+1));[e[t],e[o]]=[e[o],e[t]]}return e}function C(e,t={}){let o="default",s,a;typeof t=="number"?s=t:typeof t=="string"?o=t:typeof t=="object"&&(o=t.type??"default",s=t.duration,a=t.dismissible);const r={success:{duration:2500,dismissible:!1},info:{duration:3e3,dismissible:!1},warning:{duration:5e3,dismissible:!0},error:{duration:0,dismissible:!0},default:{duration:3e3,dismissible:!1}},d=r[o]||r.default;s=s??d.duration,a=a??d.dismissible;const i=document.querySelector(".toast");i&&i.remove();const l={success:"✓",error:"✕",warning:"⚠",info:"ℹ",default:""},c=document.createElement("div");c.className=`toast ${o}`,o==="error"?(c.setAttribute("role","alert"),c.setAttribute("aria-live","assertive")):(c.setAttribute("role","status"),c.setAttribute("aria-live","polite"));const u=l[o]||"";if(u){const p=document.createElement("span");p.className="toast-icon",p.textContent=u,c.appendChild(p)}const m=document.createElement("span");m.className="toast-message",m.textContent=e,c.appendChild(m);const f=()=>{c.classList.remove("visible"),setTimeout(()=>c.remove(),300)};if(a){const p=document.createElement("button");p.className="toast-close",p.setAttribute("aria-label","Close notification"),p.textContent="×",p.addEventListener("click",f),c.appendChild(p)}document.body.appendChild(c);const h=p=>{p.key==="Escape"&&a&&(f(),document.removeEventListener("keydown",h))};a&&document.addEventListener("keydown",h),setTimeout(()=>c.classList.add("visible"),10),s>0&&setTimeout(()=>{f(),document.removeEventListener("keydown",h)},s)}function ae(){return Math.floor(Date.now()+Math.random()*1e6)}let ue=null;function Fe(){return ue={format:document.getElementById("format"),courts:document.getElementById("courts"),scoringMode:document.getElementById("scoringMode"),points:document.getElementById("points"),matchTimerContainer:document.getElementById("matchTimerContainer"),timerDisplay:document.getElementById("timerDisplay"),timerStartBtn:document.getElementById("timerStartBtn"),timerPauseBtn:document.getElementById("timerPauseBtn"),timerResetBtn:document.getElementById("timerResetBtn"),timerAddBtn:document.getElementById("timerAddBtn"),timerSubBtn:document.getElementById("timerSubBtn"),courtFormat:document.getElementById("courtFormat"),customCourtNamesSection:document.getElementById("customCourtNamesSection"),customCourtNamesList:document.getElementById("customCourtNamesList"),maxRepeats:document.getElementById("maxRepeats"),pairingStrategy:document.getElementById("pairingStrategy"),preferredPartnersList:document.getElementById("preferredPartnersList"),addPartnerPairBtn:document.getElementById("addPartnerPairBtn"),advancedSettingsContent:document.getElementById("advancedSettingsContent"),playerList:document.getElementById("playerList"),playerCount:document.getElementById("playerCount"),playersHint:document.getElementById("playersHint"),playerInputRow:document.getElementById("playerInputRow"),playerNameInput:document.getElementById("playerNameInput"),confirmAddBtn:document.getElementById("confirmAddBtn"),generateBtn:document.getElementById("generateBtn"),scheduleSection:document.getElementById("scheduleSection"),roundsContainer:document.getElementById("roundsContainer"),leaderboardSection:document.getElementById("leaderboardSection"),leaderboardBody:document.getElementById("leaderboardBody"),printBtn:document.getElementById("printBtn"),resetBtn:document.getElementById("resetBtn"),gridColumns:document.getElementById("gridColumns"),gridColumnsLabel:document.getElementById("gridColumnsLabel"),textSize:document.getElementById("textSize"),textSizeLabel:document.getElementById("textSizeLabel"),themeToggle:document.getElementById("themeToggle"),importPlayersBtn:document.getElementById("importPlayersBtn"),importModal:document.getElementById("importModal"),closeImportModal:document.getElementById("closeImportModal"),importTextarea:document.getElementById("importTextarea"),importStatus:document.getElementById("importStatus"),cancelImportBtn:document.getElementById("cancelImportBtn"),confirmImportBtn:document.getElementById("confirmImportBtn"),clearAllPlayersBtn:document.getElementById("clearAllPlayersBtn"),runningBadge:document.getElementById("runningBadge")},ue}function k(){return ue||Fe(),ue}function ve(e){switch(n.courtFormat){case"number":return`${e}`;case"court":return`Court ${e}`;case"custom":return n.customCourtNames[e-1]||`Court ${e}`;default:return`Court ${e}`}}function je(){var i;const e=k(),t=e.courts,o=document.getElementById("courtsWarning");if(!t||!o)return!0;const s=parseInt(t.value)||1,a=((i=e.format)==null?void 0:i.value)||n.format,r=a==="team"||a==="teamMexicano"?2:4,d=Math.floor(n.players.length/r);return t.max=Math.max(1,d),s>d&&d>0?(o.textContent=`⚠️ ${n.players.length} players can only fill ${d} court${d!==1?"s":""}`,o.style.display="block",t.classList.add("input-warning"),!1):d===0&&n.players.length>0?(o.textContent=`⚠️ Need at least ${r} players for 1 court`,o.style.display="block",t.classList.add("input-warning"),!1):(o.style.display="none",t.classList.remove("input-warning"),!0)}function We(){const e=k();if(!e.customCourtNamesSection)return;n.courtFormat==="custom"?(e.customCourtNamesSection.style.display="flex",be()):e.customCourtNamesSection.style.display="none"}function be(){const e=k();if(!e.customCourtNamesList)return;const t=Math.max(1,n.courts||2);for(Array.isArray(n.customCourtNames)||(n.customCourtNames=[]);n.customCourtNames.length<t;)n.customCourtNames.push(`Court ${n.customCourtNames.length+1}`);e.customCourtNamesList.innerHTML=Array.from({length:t},(o,s)=>`
  ...
  `).join("")}function Tt(e,t){n.customCourtNames[e]=t||`Court ${e+1}`,S()}function Ve(){const e=k(),t=new Set;n.preferredPartners.forEach(o=>{t.add(o.player1Id),t.add(o.player2Id)}),n.players.filter(o=>!t.has(o.id)),e.addPartnerPairBtn.disabled=!1}function J(){const e=k(),t=o=>{const s=new Set;return n.preferredPartners.forEach(a=>{a.id!==o&&(s.add(a.player1Id),s.add(a.player2Id))}),s};if(n.preferredPartners.length===0){e.preferredPartnersList.innerHTML="";return}e.preferredPartnersList.innerHTML=`
  ...
  `,document.body.appendChild(l),setTimeout(()=>l.classList.add("visible"),10);const u=l.querySelector(".modal");u&&u.addEventListener("click",y=>y.stopPropagation());const m=l.querySelector("#modalCancelBtn"),f=l.querySelector("#modalConfirmBtn"),h=l.querySelector("#modalSecondaryBtn"),p=()=>l.remove();m&&m.addEventListener("click",y=>{y.preventDefault(),y.stopPropagation(),p()}),f&&f.addEventListener("click",y=>{y.preventDefault(),y.stopPropagation(),p(),s()}),h&&d&&h.addEventListener("click",y=>{y.preventDefault(),y.stopPropagation(),p(),d()}),l.addEventListener("click",y=>{y.target===l&&p()})}function Ye(e,t,o){const s=document.querySelector(".input-modal");s&&s.remove();const a=document.createElement("div");a.className="modal-overlay input-modal",a.style.display="flex",a.innerHTML=`
    <div class="modal" style="max-width: 400px; text-align: center;">
      <div class="modal-header">
        <h3>${e}</h3>
      </div>
  ...
  `,document.body.appendChild(s),setTimeout(()=>s.classList.add("visible"),10);const a=s.querySelector(".modal");a&&a.addEventListener("click",l=>l.stopPropagation());const r=s.querySelector("#modalOkBtn"),d=s.querySelector("#modalCloseX"),i=()=>s.remove();r&&(r.onclick=i),d&&(d.onclick=i),s.addEventListener("click",l=>{l.target===s&&i()})}function jt(){return new Promise(e=>{const t=document.createElement("div");t.className="countdown-overlay",t.innerHTML='<div class="countdown-number">3</div>',t.style.cursor="pointer",document.body.appendChild(t);let o=!1,s=null;const a=()=>{o||(o=!0,s&&clearTimeout(s),t.classList.remove("active"),setTimeout(()=>{t.remove(),e()},100))};t.addEventListener("click",a),requestAnimationFrame(()=>{t.classList.add("active")});const r=t.querySelector(".countdown-number"),d=["3","2","1","GO!"];let i=0;const l=()=>{if(o)return;if(i>=d.length){t.classList.remove("active"),setTimeout(()=>{t.remove(),e()},300);return}const c=d[i];r.textContent=c,r.className="countdown-number"+(c==="GO!"?" countdown-go":""),r.style.animation="none",requestAnimationFrame(()=>{r.style.animation=""}),i++,s=setTimeout(l,c==="GO!"?600:800)};s=setTimeout(l,100)})}window.closeFinalModal=Ft;function ze(e){if(!e.trim())return!1;const t=e.trim();return n.players.length>=24?(C("Maximum 24 players allowed"),!1):n.players.some(o=>o.name.toLowerCase()===t.toLowerCase())?(C(`Player "${t}" already exists`),!1):(n.players.push({id:ae(),name:t,points:0,wins:0,losses:0,pointsLost:0,played:0}),n.players.length%4===0&&(n.courts=n.players.length/4),S(),!0)}function Ge(e){n.players=n.players.filter(t=>t.id!==e),S()}function Wt(e){if(console.log("removeAllPlayers called, players:",n.players.length),n.players.length===0){console.log("No players to remove");return}H("Remove All Players?","Are you sure you want to clear the entire player list? This action cannot be undone.","Yes, Remove All",()=>{console.log("Confirm callback executed"),n.players=[],n.preferredPartners=[],S(),console.log("Players cleared, state:",n.players),e&&e()},!0)}function Vt(e){if(!e.trim())return{added:0,duplicates:0,hitLimit:!1};const t=e.split(/[\n,]+/).map(d=>d.trim()).filter(d=>d);if(t.length===0)return{added:0,duplicates:0,hitLimit:!1};let o=0,s=0,a=!1;for(const d of t){if(n.players.length>=24){a=!0;break}if(n.players.some(i=>i.name.toLowerCase()===d.toLowerCase())){s++;continue}n.players.push({id:ae(),name:d,points:0,wins:0,losses:0,pointsLost:0,played:0}),o++}const r=Math.floor(n.players.length/4);return r>n.courts&&(n.courts=r),S(),{added:o,duplicates:s,hitLimit:a}}function Ut(e){const t={id:ae(),name:e,points:0,wins:0,losses:0,played:0,pointsLost:0,byeCount:0,playedWith:[]};return n.players.push(t),n.leaderboard.push(t),S(),!0}function Je(){const e=new Set;return n.preferredPartners.forEach(t=>{e.add(t.player1Id),e.add(t.player2Id)}),n.players.filter(t=>!e.has(t.id))}function Yt(){const e=Je();e.length<2||(n.preferredPartners.push({id:ae(),player1Id:e[0].id,player2Id:e[1].id}),S())}function ke(e){n.preferredPartners=n.preferredPartners.filter(t=>t.id!==e),S()}function Ke(e,t,o){const s=n.preferredPartners.find(a=>a.id===e);s&&(t===1?s.player1Id=o:s.player2Id=o,S())}const Xe={format:{label:"Format",type:"select",options:[{value:"americano",label:"Americano"},{value:"mexicano",label:"Mexicano"},{value:"team",label:"Team Americano"},{value:"teamMexicano",label:"Team Mexicano"}],helpId:"helpFormat"},courts:{label:"Courts",type:"number",min:1,max:50},scoringMode:{label:"Scoring",type:"select",options:[{value:"total",label:"Total Points"},{value:"race",label:"Race to"},{value:"time",label:"Timed"}],helpId:"helpScoring"},pointsPerMatch:{label:"Points",type:"number",min:4,max:50},maxRepeats:{label:"Repeats",type:"select",options:[{value:0,label:"No repeats"},{value:1,label:"Max 1x"},{value:2,label:"Max 2x"},{value:3,label:"Max 3x"},{value:99,label:"Unlimited"}],mexicanoOnly:!0,helpId:"helpMatchup"},pairingStrategy:{label:"Pairing",type:"select",options:[{value:"optimal",label:"Optimal"},{value:"oneThree",label:"1&3 vs 2&4"},{value:"oneTwo",label:"1&2 vs 3&4"},{value:"oneFour",label:"1&4 vs 2&3"}],mexicanoOnly:!0,helpId:"helpMatchup"},strictStrategy:{label:"Prioritize Pattern",type:"toggle",mexicanoOnly:!0,helpId:"helpMatchup"}};function qe(){return n.scoringMode==="time"?"Minutes":n.scoringMode==="race"?"Race to":"Total Points"}function F(){var r,d;const e=document.getElementById("tournamentConfig");if(!e)return;if(Kt(e),n.isLocked){e.style.display="none";return}e.style.display="block",n.format==="team"||n.format;const t=n.format==="mexicano"||n.format==="teamMexicano",o=((r=n.players)==null?void 0:r.length)||0,s=Math.max(1,Math.floor(o/4));n.courts>s&&(n.courts=s,S()),n.pointsPerMatch<4?(n.pointsPerMatch=4,S()):n.pointsPerMatch>50&&(n.pointsPerMatch=50,S());let a='<div class="config-grid">';if(a+=W("format",n.format),t?(a+='<div class="config-spacer"></div>',a+=W("scoringMode",n.scoringMode),a+=W("pointsPerMatch",n.pointsPerMatch,{label:qe()}),a+=W("maxRepeats",n.maxRepeats),a+=W("courts",n.courts),a+=W("pairingStrategy",n.pairingStrategy),a+=W("strictStrategy",n.strictStrategy,{disabled:n.pairingStrategy==="optimal"}),n.pairingStrategy!=="optimal"&&n.strictStrategy&&n.maxRepeats===0&&(a+=`
    ...
    `);e.innerHTML=a}function _t(e,t,o){const s=o.options.find(r=>String(r.value)===String(t)),a=s?s.label:t;return`
  ...
  `}function Gt(e,t,o){const s=o.min??1,a=o.max??99,r=Number.isFinite(t)?t:s,d=r<=s,i=r>=a,l=e==="pointsPerMatch"&&n.scoringMode!=="time"?2:1;return`
  ...
  `}function Jt(e,t,o={}){const s=!!t,a=!!o.disabled;return`
  ...
  `}).join(""),window.updatePlayerCourtLock||(window.updatePlayerCourtLock=(t,o)=>{const s=n.players.find(a=>a.id===t);s&&(s.lockedCourt=o?parseInt(o):null,S())}),e.playerCount.textContent=`(${n.players.length})`,e.generateBtn.disabled=n.players.length<4,n.players.length>=4){const t=n.players.length%4===0,o=n.courts*4,s=n.players.length>o;if(!t||s){const a=s?`exceeds capacity for ${n.courts} court${n.courts>1?"s":""}`:`uneven number for ${n.courts} court${n.courts>1?"s":""}`;e.playersHint.textContent=`${n.players.length} players ready! Since it ${a}, a queue system will be applied.`,e.playersHint.style.color="var(--warning)"}else e.playersHint.textContent=`${n.players.length} players ready`,e.playersHint.style.color="var(--success)"}else e.playersHint.textContent=`Add at least ${4-n.players.length} more player${4-n.players.length>1?"s":""}`,e.playersHint.style.color="";J(),Ve(),Zt(),je(),oe(),F()}function Pe(){const e=document.getElementById("playerListWrapper"),t=document.getElementById("expandPlayersBtn");e.classList.contains("expanded")?(e.classList.remove("expanded"),t.innerHTML=`Show All Players (${n.players.length}) ▼`):(e.classList.add("expanded"),t.innerHTML="Show Less ▲")}function Zt(){const e=document.getElementById("expandPlayersBtn"),t=document.getElementById("playerListWrapper");e&&!(t!=null&&t.classList.contains("expanded"))&&(e.innerHTML=`Show All Players (${n.players.length}) ▼`)}function Qe(){const e=k();e.importModal.style.display="flex",e.importTextarea.value="",e.importStatus.textContent="",e.importTextarea.focus()}function de(){const e=k();e.importModal.style.display="none"}const en=Object.freeze(Object.defineProperty({__proto__:null,hideImportModal:de,renderPlayers:Y,showImportModal:Qe,togglePlayerList:Pe},Symbol.toStringTag,{value:"Module"}));let Ce=!1;function fe(){const e=k(),t=n.gridColumns,o=document.querySelectorAll(".matches-grid");e.gridColumns&&(e.gridColumns.value=t),t===0?(e.gridColumnsLabel&&(e.gridColumnsLabel.textContent="Auto"),o.forEach(s=>{s.style.gridTemplateColumns=""})):(e.gridColumnsLabel&&(e.gridColumnsLabel.textContent=t),o.forEach(s=>{s.style.gridTemplateColumns=`repeat(${t}, 1fr)`}))}function Ze(){var s;const e=((s=document.getElementById("scoringMode"))==null?void 0:s.value)||n.scoringMode,t=document.getElementById("scoringValueLabel"),o=document.getElementById("points");!t||!o||(e==="total"?(t.textContent="Points",o.value=24):e==="race"?(t.textContent="Target",o.value=21):e==="time"&&(t.textContent="Minutes",o.value=12))}function tn(){const e=k();e.gridColumns&&(e.gridColumns.max=6)}function nn(){const e=document.querySelector(".matches-grid");if(!e)return n.maxCourts||2;const t=e.offsetWidth,s=Math.floor(t/180),a=n.maxCourts||n.courts||2;return Math.min(Math.max(s,1),a)}function et(){const e=k();if(Ce||n.gridColumns!==0)return;const t=nn();document.querySelectorAll(".matches-grid").forEach(s=>{s.style.gridTemplateColumns=`repeat(${t}, 1fr)`}),e.gridColumns&&(e.gridColumns.value=t),e.gridColumnsLabel&&(e.gridColumnsLabel.textContent=`Auto (${t})`)}function on(){const e=k(),t=parseInt(e.gridColumns.value);t===0?(Ce=!1,et()):Ce=!0,n.gridColumns=t,fe(),S()}function tt(){const e=k(),t=n.textSize,o=t/100,s=document.getElementById("scheduleSection");s&&s.style.setProperty("--text-scale",o),e.textSize&&(e.textSize.value=t),e.textSizeLabel&&(e.textSizeLabel.textContent=`${t}%`)}function sn(){const e=document.getElementById("roundScale"),t=document.getElementById("roundScaleLabel");e&&(n.roundScale=parseInt(e.value)/100,S());const o=n.roundScale||1,s=document.getElementById("roundsContainer");s&&s.style.setProperty("--card-scale",o),e&&(e.value=Math.round(o*100)),t&&(t.textContent=`${Math.round(o*100)}%`)}function nt(){return[...n.leaderboard].sort((e,t)=>{switch(n.rankingCriteria){case"wins":return t.wins!==e.wins?t.wins-e.wins:t.points!==e.points?t.points-e.points:t.points-t.pointsLost-(e.points-e.pointsLost);case"winRatio":const o=e.played>0?e.wins/e.played:0,s=t.played>0?t.wins/t.played:0;return Math.abs(s-o)>.001?s-o:t.wins!==e.wins?t.wins-e.wins:t.points-e.points;case"pointRatio":const a=e.points+e.pointsLost,r=t.points+t.pointsLost,d=a>0?e.points/a:0,i=r>0?t.points/r:0;return Math.abs(i-d)>.001?i-d:t.points-e.points;case"points":default:return t.points!==e.points?t.points-e.points:t.wins!==e.wins?t.wins-e.wins:t.points-t.pointsLost-(e.points-e.pointsLost)}})}function j(){const e=k(),t=document.getElementById("toggleVisibilityBtn");t&&(n.hideLeaderboard?(t.innerHTML="Scores",t.classList.add("toggle-off"),t.classList.remove("toggle-on")):(t.innerHTML="Scores",t.classList.add("toggle-on"),t.classList.remove("toggle-off")),t.title="Click to toggle score visibility");const o=document.getElementById("togglePositionBtn");if(o&&(n.showPositionChanges?(o.innerHTML="Ranks",o.classList.add("toggle-on"),o.classList.remove("toggle-off")):(o.innerHTML="Ranks",o.classList.add("toggle-off"),o.classList.remove("toggle-on")),o.title="Click to toggle rank change indicators"),!n.leaderboard||n.leaderboard.length===0){e.leaderboardBody.innerHTML='<tr><td colspan="7" class="text-center">No players yet</td></tr>';return}const s=!n.hideLeaderboard,a=n.showPositionChanges,r=!s&&!a,d=nt();d.forEach((l,c)=>{const u=c+1,m=l.previousRank||u;l.rankChange=m-u});let i=r?[...d].sort(()=>Math.random()-.5):d;e.leaderboardBody.innerHTML=i.map((l,c)=>{const u=d.findIndex(g=>g.id===l.id)+1,m=r?"-":u;let f="";a&&l.played>0&&!r&&(l.rankChange>0?f='<span class="rank-up">▲</span>':l.rankChange<0?f='<span class="rank-down">▼</span>':f='<span class="rank-same">-</span>');const h=l.points-(l.pointsLost||0),p=l.played>0?Math.round((l.wins||0)/l.played*100)+"%":"0%",y=h>0?"+":"",v=s?l.points:"-",b=s?l.wins||0:"-",L=s?`<span class="${h>0?"text-success":h<0?"text-error":""}">${y}${h}</span>`:"-",z=s?p:"-",B=s||a?l.played:"-";return`
    <tr>
      <td>${m} ${f}</td>
  ...
  `}).join("")}function ot(){n.hideLeaderboard=!n.hideLeaderboard,j()}function st(){n.showPositionChanges=!n.showPositionChanges,j()}function at(e){n.rankingCriteria=e,j()}function an(){const e=[...n.players],t=e.length,o=n.courts;t%2!==0&&e.push({id:-1,name:"BYE",isBye:!0});const s=e.length,a=[],r=e[0],d=e.slice(1);for(let i=0;i<s-1;i++){const l=[r,...d],c=[];for(let y=0;y<s/2;y++){const v=l[y],b=l[s-1-y];!v.isBye&&!b.isBye&&c.push([v,b])}const u=[],m=new Set;for(let y=0;y<c.length-1;y+=2)c[y]&&c[y+1]&&(u.push({court:Math.floor(y/2)+1,team1:c[y],team2:c[y+1]}),c[y].forEach(v=>m.add(v.id)),c[y+1].forEach(v=>m.add(v.id)));const f=u.slice(0,o),h=new Set;f.forEach(y=>{y.team1.forEach(v=>h.add(v.id)),y.team2.forEach(v=>h.add(v.id))});const p=n.players.filter(y=>!y.isBye&&!h.has(y.id));f.length>0&&a.push({number:a.length+1,matches:f,byes:p}),d.unshift(d.pop())}return a}function rn(){const e=[...n.players],t=e.length,o=n.courts;t%2!==0&&e.push({id:-1,name:"BYE",isBye:!0});const s=e.length,a=[],r=e[0],d=e.slice(1);for(let i=0;i<s-1;i++){const l=[r,...d],c=[],u=new Set;for(let p=0;p<s/2;p++){const y=l[p],v=l[s-1-p];!y.isBye&&!v.isBye&&(c.push({court:c.length+1,team1:[y],team2:[v]}),u.add(y.id),u.add(v.id))}const m=c.slice(0,o),f=new Set;m.forEach(p=>{p.team1.forEach(y=>f.add(y.id)),p.team2.forEach(y=>f.add(y.id))});const h=n.players.filter(p=>!p.isBye&&!f.has(p.id));m.length>0&&a.push({number:a.length+1,matches:m,byes:h}),d.unshift(d.pop())}return a}function ln(){const e=[...n.players];le(e);const t=n.courts,o=[],s=new Set;for(let r=0;r<e.length-1&&o.length<t;r+=2)o.push({court:o.length+1,team1:[e[r]],team2:[e[r+1]]}),s.add(e[r].id),s.add(e[r+1].id);const a=e.filter(r=>!s.has(r.id));return[{number:1,matches:o,byes:a}]}function dn(){const e=[...n.leaderboard].sort((i,l)=>l.points-i.points),t=n.courts,o=e.filter(i=>!n.manualByes.includes(i.id)),s=e.filter(i=>n.manualByes.includes(i.id)),a=[],r=new Set;for(let i=0;i<o.length-1&&a.length<t;i+=2)a.push({court:a.length+1,team1:[o[i]],team2:[o[i+1]]}),r.add(o[i].id),r.add(o[i+1].id);const d=[...s,...o.filter(i=>!r.has(i.id))];return{number:n.schedule.length+1,matches:a,byes:d}}function cn(){const e=n.courts,t=e*4,o=[],s=new Set,a=[...n.players],r=[];a.forEach(p=>{if(s.has(p.id))return;const y=rt(p.id);if(y){const v=a.find(b=>b.id===y);v?(o.push({type:"pair",players:[p,v]}),s.add(v.id)):o.push({type:"single",players:[p]})}else o.push({type:"single",players:[p]});s.add(p.id)}),le(o);const d=[];let i=0;for(const p of o)i+p.players.length<=t?(d.push(p),i+=p.players.length):r.push(...p.players);const l=[],c=[];d.forEach(p=>{p.type==="pair"?l.push(p.players):c.push(p.players[0])}),le(c);for(let p=0;p<c.length-1;p+=2)l.push([c[p],c[p+1]]);le(l);const u=[],m=new Set,f=[],h=[];for(let p=0;p<l.length-1;p+=2){const y=l[p],v=l[p+1],b=[...y,...v].find(L=>L.lockedCourt);b?f.push({team1:y,team2:v,lockedCourt:b.lockedCourt}):h.push({team1:y,team2:v})}return f.forEach(p=>{if(u.length>=e)return;let y=p.lockedCourt;(m.has(y)||y>e)&&(y=null),y?(m.add(y),u.push({court:y,team1:p.team1,team2:p.team2})):h.push({team1:p.team1,team2:p.team2})}),h.forEach(p=>{if(u.length>=e)return;let y=1;for(;m.has(y);)y++;y<=e&&(m.add(y),u.push({court:y,team1:p.team1,team2:p.team2}))}),u.sort((p,y)=>p.court-y.court),l.length%2!==0&&u.length<l.length/2&&r.push(...l[l.length-1]),[{number:1,matches:u,byes:r}]}function rt(e){if(!n.preferredPartners)return null;const t=n.preferredPartners.find(o=>o.player1Id===e||o.player2Id===e);return t?t.player1Id===e?t.player2Id:t.player1Id:null}function un(e){const t=n.courts,o=t*4,s=new Set(n.manualByes),a=[],r=new Set,d=[...e];d.forEach(g=>{if(r.has(g.id)||s.has(g.id))return;const x=rt(g.id);if(x){const w=d.find(E=>E.id===x);w?s.has(w.id)?a.push({type:"single",players:[g]}):(a.push({type:"pair",players:[g,w]}),r.add(w.id)):a.push({type:"single",players:[g]})}else a.push({type:"single",players:[g]});r.add(g.id)}),a.sort((g,x)=>{const w=A=>{const K=A.players.reduce((O,I)=>O+(I.byeCount||0),0),te=A.players.reduce((O,I)=>O+(I.played||0),0);return{bye:K/A.players.length,play:te/A.players.length}},E=w(g),$=w(x);return Math.abs($.bye-E.bye)>.1?$.bye-E.bye:E.play-$.play});const i=[],l=[];let c=0;for(const g of a)c+g.players.length<=o&&(l.push(g),i.push(...g.players),c+=g.players.length);const u=new Set(i.map(g=>g.id)),m=d.filter(g=>!u.has(g.id)),f=[],h=[];l.forEach(g=>{g.type==="pair"?f.push(g.players):h.push(g.players[0])}),h.sort((g,x)=>x.points-g.points);let p=0;for(;p<h.length-3;p+=4){const g=h[p],x=h[p+1],w=h[p+2],E=h[p+3],$=[{name:"oneThree",team1:[g,w],team2:[x,E]},{name:"oneTwo",team1:[g,x],team2:[w,E]},{name:"oneFour",team1:[g,E],team2:[x,w]}];let A;const K=n.pairingStrategy!=="optimal"&&n.strictStrategy;n.strictStrategy;const te=n.maxRepeats!==void 0?n.maxRepeats:99,O=$.map(I=>{const R=I.team1[0].id,D=I.team1[1].id,M=I.team2[0].id,N=I.team2[1].id,Me=(Lt,Et)=>{const ie=e.find(ye=>ye.id===Lt);return ie!=null&&ie.playedWith?ie.playedWith.filter(ye=>ye===Et).length:0},Te=Me(R,D)+Me(M,N),vt=I.team1[0].points+I.team1[1].points,bt=I.team2[0].points+I.team2[1].points,xt=Math.abs(vt-bt),wt=te<99&&Te>te,St=I.name===n.pairingStrategy,Ct=R*1e6+D*1e4+M*100+N;return{...I,repeatPenalty:Te,violatesRepeats:wt,isPreferred:St,rankingImbalance:xt,tieBreaker:Ct}});if(O.sort((I,R)=>I.tieBreaker-R.tieBreaker),n.pairingStrategy==="optimal")A={...[...O].sort((R,D)=>R.repeatPenalty!==D.repeatPenalty?R.repeatPenalty-D.repeatPenalty:R.rankingImbalance!==D.rankingImbalance?R.rankingImbalance-D.rankingImbalance:R.tieBreaker-D.tieBreaker)[0],relaxedConstraint:null};else{const I=O.find(R=>R.isPreferred)||O[0];if(!I.violatesRepeats)A={...I,relaxedConstraint:null};else if(K)A={...I,relaxedConstraint:"repeats"};else{const R=O.filter(D=>!D.violatesRepeats);R.length>0?A={...[...R].sort((M,N)=>M.isPreferred!==N.isPreferred?M.isPreferred?-1:1:M.rankingImbalance!==N.rankingImbalance?M.rankingImbalance-N.rankingImbalance:M.tieBreaker-N.tieBreaker)[0],relaxedConstraint:"pattern"}:A={...[...O].sort((M,N)=>M.repeatPenalty!==N.repeatPenalty?M.repeatPenalty-N.repeatPenalty:M.isPreferred!==N.isPreferred?M.isPreferred?-1:1:M.rankingImbalance!==N.rankingImbalance?M.rankingImbalance-N.rankingImbalance:M.tieBreaker-N.tieBreaker)[0],relaxedConstraint:"tier3"}}}f.push(A.team1),f.push(A.team2)}p<h.length-1&&f.push([h[p],h[p+1]]);const y=f.map(g=>({players:g,points:g.reduce((x,w)=>x+w.points,0)}));y.sort((g,x)=>x.points-g.points);const v=[],b=new Set,L=new Set,z=[],B=[];for(let g=0;g<y.length-1;g+=2){const x=y[g],w=y[g+1],E=[...x.players,...w.players].find($=>$.lockedCourt);E?z.push({t1:x,t2:w,lockedCourt:E.lockedCourt}):B.push({t1:x,t2:w})}return z.forEach(g=>{if(v.length>=t)return;let x=g.lockedCourt;(L.has(x)||x>t)&&(x=null),x?(L.add(x),v.push({court:x,team1:g.t1.players,team2:g.t2.players}),g.t1.players.forEach(w=>b.add(w.id)),g.t2.players.forEach(w=>b.add(w.id))):B.push({t1:g.t1,t2:g.t2})}),B.forEach(g=>{if(v.length>=t)return;let x=1;for(;L.has(x);)x++;x<=t&&(L.add(x),v.push({court:x,team1:g.t1.players,team2:g.t2.players}),g.t1.players.forEach(w=>b.add(w.id)),g.t2.players.forEach(w=>b.add(w.id)))}),v.sort((g,x)=>g.court-x.court),y.forEach(g=>{g.players.some(x=>b.has(x.id))||g.players.forEach(x=>m.push(x))}),{number:n.schedule.length+1,matches:v,byes:m}}function X(e,t,o,s,a,r=null){const d=n.leaderboard.find(i=>i.id===e);d&&(d.points+=t,d.played+=1,d.pointsLost=(d.pointsLost||0)+o,s?d.wins=(d.wins||0)+1:a||(d.losses=(d.losses||0)+1),r&&!d.playedWith&&(d.playedWith=[]),r&&d.playedWith.push(r))}function Q(e,t,o,s,a){const r=n.leaderboard.find(d=>d.id===e);r&&(r.points-=t,r.played-=1,r.pointsLost=(r.pointsLost||0)-o,s?r.wins=(r.wins||0)-1:a||(r.losses=(r.losses||0)-1),r.played<0&&(r.played=0),r.points<0&&(r.points=0),r.wins<0&&(r.wins=0),r.losses<0&&(r.losses=0),r.pointsLost<0&&(r.pointsLost=0))}let Le=null;function mn(e){Le=e}let Ee=null;function pn(e){Ee=e}function q(){const e=k(),t=n.format,o=t==="team"||t==="teamMexicano",s=document.getElementById("playersHeader");s&&s.firstChild&&(s.firstChild.textContent=o?"Teams ":"Players "),e.addPlayerBtn&&(e.addPlayerBtn.textContent=o?"+ Add Team":"+ Add Player"),e.playerNameInput&&(e.playerNameInput.placeholder=o?"Enter team name...":"Enter name...");const a=document.querySelector(".setup-card");if(!a)return;[a.querySelector(".setup-grid"),a.querySelector(".setup-grid-3"),document.getElementById("customCourtNamesSection")].forEach(p=>{if(!p)return;p.querySelectorAll("input, select, button").forEach(v=>{if(!v.classList.contains("always-enabled")){if(n.isLocked){if(v.disabled=!0,v.classList.add("locked"),v.tagName==="SELECT"){const b=v.closest(".custom-select-wrapper");if(b){const L=b.querySelector(".custom-select");L&&L.classList.add("disabled")}}}else if(v.disabled=!1,v.classList.remove("locked"),v.tagName==="SELECT"){const b=v.closest(".custom-select-wrapper");if(b){const L=b.querySelector(".custom-select");L&&L.classList.remove("disabled")}}}})});const d=document.getElementById("advancedSettingsContent");d&&(d.querySelectorAll("input, select, button").forEach(y=>{if(y.disabled=!1,y.classList.remove("locked"),y.tagName==="SELECT"){const v=y.closest(".custom-select-wrapper");if(v){const b=v.querySelector(".custom-select");b&&b.classList.remove("disabled")}}}),Ve());const i=document.getElementById("runningBadge");n.isLocked?(e.generateBtn.style.display="none",i&&(i.style.display="inline-flex")):(e.generateBtn.style.display="block",i&&(i.style.display="none"),e.generateBtn.textContent="Generate Schedule",e.generateBtn.disabled=!1);const l=String(t).trim(),m=l.toLowerCase()==="mexicano"||l==="teamMexicano",f=e.advancedSettingsContent;f&&(m?(f.classList.remove("collapsed"),f.classList.add("expanded")):(f.classList.remove("expanded"),f.classList.add("collapsed")));const h=document.getElementById("strictStrategy");h&&(h.disabled=!1),Ee&&Ee()}function fn(){const e=k(),t=e.format.value,o=t==="team"||t==="teamMexicano",s=o?2:4;if(n.players.length<s){C(`Not enough ${o?"teams":"players"} (min ${s})`,"error");return}n.format=e.format.value,n.courts=parseInt(e.courts.value),n.scoringMode=e.scoringMode.value,n.pointsPerMatch=parseInt(e.points.value),n.currentRound=1;const a=n.format==="team"||n.format==="teamMexicano"?2:4,r=Math.floor(n.players.length/a),d=()=>{pe(),n.leaderboard=n.players.map(l=>({...l,points:0,wins:0,losses:0,pointsLost:0,played:0,byeCount:0,playedWith:[]})),n.format==="americano"?(n.allRounds=an(),n.schedule=[n.allRounds[0]]):n.format==="team"?(n.allRounds=rn(),n.schedule=[n.allRounds[0]]):n.format==="teamMexicano"?(n.schedule=ln(),n.allRounds=null):(n.schedule=cn(),n.allRounds=null),e.leaderboardSection.style.display="block",j(),Le&&Le(),e.scheduleSection.style.display="block";const i=document.getElementById("tournamentActionsSection");i&&(i.style.display="block"),e.scheduleSection.scrollIntoView({behavior:"smooth"}),setTimeout(()=>{const l=document.getElementById("round-0");l&&(l.classList.add("animate-in","highlight"),setTimeout(()=>{l.classList.remove("animate-in","highlight")},1600))},100),n.isLocked=!0,q(),S(),C("🎾 Tournament started! Round 1 ready")};if(n.courts>r){if(r===0){we("Not Enough Players",`You need at least ${a} players/teams to start!`);return}const i=n.courts;n.courts=r,e.courts&&(e.courts.value=n.courts),C(`Adjusted courts: ${i} → ${r}`)}jt().then(()=>{d()})}function yn(){const e=k();H("Reset Tournament?","This will clear all rounds and scores.","Reset",()=>{pe(),n.schedule=[],n.currentRound=0,n.leaderboard=[],n.allRounds=null,n.isLocked=!1,n.hideLeaderboard=!1,n.manualByes=[],e.scheduleSection.style.display="none",e.leaderboardSection.style.display="none",q(),S(),C("Tournament reset")},!0)}function it(e){H("End Tournament?","This will show final standings. This action cannot be undone.","End Tournament",()=>{n.isLocked=!1,n.hideLeaderboard=!1,q();const t=[...n.leaderboard].sort((o,s)=>s.points-o.points);vn(),C("Tournament saved to history"),e&&e(t),j(),S()},!0)}function lt(){document.getElementById("scheduleToolbar").classList.toggle("collapsed")}function dt(e=null){const t=e||n,o=new Date().toLocaleDateString(),s=new Date().toLocaleTimeString();let a="data:text/csv;charset=utf-8,";a+=`Tournament Results
`,a+=`Date,${o} ${s}
`,a+=`Format,${t.format}
...
`})});const d=encodeURI(a),i=document.createElement("a");i.setAttribute("href",d),i.setAttribute("download",`padel_tournament_${new Date().toISOString().slice(0,10)}.csv`),document.body.appendChild(i),i.click(),document.body.removeChild(i)}async function ct(e=null){var r;const t=e||n;let s=`Padel Tournament Results - ${new Date().toLocaleDateString()}
...
Full results: https://padelcompanion.se/tournament/`;try{await navigator.clipboard.writeText(s),C("Results copied to clipboard")}catch(d){console.error("Failed to copy: ",d),C("Failed to copy results","error")}}class gn{constructor(t={}){this.duration=t.duration||12,this.onTimeUpdate=t.onTimeUpdate||(()=>{}),this.onStatusChange=t.onStatusChange||(()=>{}),this.onComplete=t.onComplete||(()=>{}),this.remainingSeconds=this.duration*60,this.isRunning=!1,this.intervalId=null,this.audioContext=null}start(){this.isRunning||(this.remainingSeconds<=0&&this.reset(),this.isRunning=!0,this.onStatusChange("running"),this.intervalId=setInterval(()=>{this.tick()},1e3),this.playBeep(880,.1))}pause(){this.isRunning&&(this.isRunning=!1,clearInterval(this.intervalId),this.onStatusChange("paused"))}reset(){this.pause(),this.remainingSeconds=this.duration*60,this.onTimeUpdate(this.formatTime(this.remainingSeconds)),this.onStatusChange("idle")}setDuration(t){this.duration=t,this.reset()}addTime(t){this.remainingSeconds+=t,this.onTimeUpdate(this.formatTime(this.remainingSeconds))}tick(){this.remainingSeconds--,this.remainingSeconds<=3&&this.remainingSeconds>0&&this.playBeep(440,.2),this.remainingSeconds<=0?this.complete():this.onTimeUpdate(this.formatTime(this.remainingSeconds))}complete(){this.remainingSeconds=0,this.pause(),this.onTimeUpdate("00:00"),this.onStatusChange("completed"),this.playBeep(880,1),this.onComplete()}formatTime(t){const o=Math.floor(t/60),s=t%60;return`${o.toString().padStart(2,"0")}:${s.toString().padStart(2,"0")}`}playBeep(t=440,o=.5){try{this.audioContext||(this.audioContext=new(window.AudioContext||window.webkitAudioContext)),this.audioContext.state==="suspended"&&this.audioContext.resume();const s=this.audioContext.createOscillator(),a=this.audioContext.createGain();s.type="sine",s.frequency.value=t,s.connect(a),a.connect(this.audioContext.destination),s.start(),a.gain.setValueAtTime(.1,this.audioContext.currentTime),a.gain.exponentialRampToValueAtTime(.001,this.audioContext.currentTime+o),s.stop(this.audioContext.currentTime+o)}catch(s){console.warn("Audio play failed",s)}}}let T=null;function hn(){const e=k();if(e.matchTimerContainer){if(n.scoringMode!=="time"){e.matchTimerContainer.style.display="none",T&&(T.pause(),T=null);return}if(e.matchTimerContainer.style.display="flex",T)T.duration!==n.pointsPerMatch&&T.setDuration(n.pointsPerMatch);else{T=new gn({duration:n.pointsPerMatch||12,onTimeUpdate:o=>{e.timerDisplay&&(e.timerDisplay.textContent=o),document.title=`${o} - Tournament`},onStatusChange:o=>{o==="running"?(e.timerStartBtn.style.display="none",e.timerPauseBtn.style.display="inline-block",e.matchTimerContainer.classList.add("running"),e.matchTimerContainer.classList.remove("completed"),e.runningBadge&&(e.runningBadge.style.display="inline-flex",e.runningBadge.classList.add("running"))):o==="paused"||o==="idle"?(e.timerStartBtn.style.display="inline-block",e.timerPauseBtn.style.display="none",e.matchTimerContainer.classList.remove("running"),e.runningBadge&&(e.runningBadge.style.display="none",e.runningBadge.classList.remove("running")),o==="idle"&&e.matchTimerContainer.classList.remove("completed"),document.title="Tournament Generator - Padel Companion"):o==="completed"&&(e.matchTimerContainer.classList.remove("running"),e.matchTimerContainer.classList.add("completed"),document.title="TIME UP!",document.body.classList.add("timer-finished-flash"),setTimeout(()=>{document.body.classList.remove("timer-finished-flash")},1e3))}}),e.timerDisplay.textContent=T.formatTime(n.pointsPerMatch*60),e.timerStartBtn.onclick=()=>T.start(),e.timerPauseBtn.onclick=()=>T.pause(),e.timerResetBtn.onclick=()=>T.reset(),e.timerAddBtn.onclick=()=>T.addTime(60),e.timerSubBtn&&(e.timerSubBtn.onclick=()=>T.addTime(-60));const t=()=>{const o=()=>{Ye("Set Timer Duration","Enter minutes (e.g. 12)",s=>{const a=parseInt(s);a>0?(n.pointsPerMatch=a,S(),T.setDuration(a),C(`Timer set to ${a} minutes`)):C("Invalid minutes","error")})};T.isRunning?H("Pause Timer?","The timer is currently running. Pause to change duration?","Pause & Edit",()=>{T.pause(),o()}):o()};e.timerDisplay.onclick=t}}}function U(){const e=k();hn(),ce();const t=n.schedule.length-1;e.roundsContainer.innerHTML=n.schedule.map((r,d)=>{const i=d===t,l=r.completed,c=l&&!i,u=l?r.matches.map(m=>`${m.score1}-${m.score2}`).join(" · "):"";return`
  ...
  `).join("")}mn(U);function Ie(e,t,o,s){setTimeout(ut,0);let a=parseInt(s);if(isNaN(a)||a<0)return;const r=parseInt(n.pointsPerMatch);if(!(isNaN(r)||r<=0)){if(n.scoringMode==="total"){if(a>r){a=r;const c=document.getElementById(`score-${e}-${t}-${o}`);c&&(c.value=a)}const d=o===1||o==="1"?2:1,i=r-a,l=document.getElementById(`score-${e}-${t}-${d}`);l&&i>=0&&(l.value=i)}else if(n.scoringMode==="race"){if(a<r){const d=o===1||o==="1"?2:1,i=document.getElementById(`score-${e}-${t}-${d}`);i&&(i.value=r)}else if(a===r){const d=o===1||o==="1"?2:1,i=document.getElementById(`score-${e}-${t}-${d}`);i&&i.value===""&&(i.value=0)}}(score1Input==null?void 0:score1Input.value)!==""&&(score2Input==null?void 0:score2Input.value)!==""&&(score1Input==null||score1Input.classList.remove("error"),score2Input==null||score2Input.classList.remove("error"))}}function ut(){const e=n.schedule.findIndex(r=>!r.completed);if(e===-1)return;const t=n.schedule[e],o=document.querySelector(".complete-round-btn");if(!o)return;let s=!0;const a=parseInt(n.pointsPerMatch);for(let r=0;r<t.matches.length;r++){const d=document.getElementById(`score-${e}-${r}-1`),i=document.getElementById(`score-${e}-${r}-2`);if(!d||!i)continue;const l=d.value,c=i.value;if(l===""||c===""){s=!1;break}const u=parseInt(l),m=parseInt(c);if(n.scoringMode==="total"){if(u+m!==a){s=!1;break}}else if(u<0||m<0){s=!1;break}}o.disabled=!1,s?(o.classList.remove("btn-warning"),o.classList.add("btn-success"),o.textContent=`Complete Round ${t.number}`):(o.classList.add("btn-warning"),o.classList.remove("btn-success"),o.textContent="Complete Anyway")}function mt(e){const t=document.getElementById(`round-${e}`);if(!t)return;if(t.classList.contains("collapsed")){t.classList.remove("collapsed");const s=t.querySelector(".collapse-icon");s&&(s.textContent="▼");const a=t.querySelector(".round-summary");a&&(a.style.display="none")}else{t.classList.add("collapsed");const s=t.querySelector(".collapse-icon");s&&(s.textContent="▶");const a=t.querySelector(".round-summary");a&&(a.style.display="")}}function pt(e){const t=n.manualByes.indexOf(e);if(t!==-1){n.manualByes.splice(t,1),U();return}const o=n.courts*4,s=n.leaderboard.length,a=Math.max(0,s-o);if(a===0){C(`All ${s} players needed for ${n.courts} courts.`);return}if(n.manualByes.length>=a){C(`Max ${a} can rest. Deselect someone first.`);return}n.manualByes.push(e),U()}function ft(){const e=n.schedule.length-1,t=n.schedule[e];let o=!0;const s=[];if(t.matches.forEach((a,r)=>{const d=document.getElementById(`score-${e}-${r}-1`),i=document.getElementById(`score-${e}-${r}-2`),l=d==null?void 0:d.value,c=i==null?void 0:i.value;let u=!0;(l===""||c==="")&&(u=!1,l===""&&(d==null||d.classList.add("error")),c===""&&(i==null||i.classList.add("error")));const m=parseInt(l)||0,f=parseInt(c)||0;if(n.scoringMode==="total"){const h=parseInt(n.pointsPerMatch,10);m+f!==h?(u=!1,d==null||d.classList.add("error"),i==null||i.classList.add("error")):l!==""&&c!==""&&(d==null||d.classList.remove("error"),i==null||i.classList.remove("error"))}else m<0||f<0?(u=!1,d==null||d.classList.add("error"),i==null||i.classList.add("error")):l!==""&&c!==""&&(d==null||d.classList.remove("error"),i==null||i.classList.remove("error"));u||(o=!1,s.push(ve(a.court)))}),!o){const a=s.length>0?` on ${s.join(", ")}`:"";H("Incomplete/Invalid Scores",`Some matches have missing or invalid scores${a}. Do you want to complete the round anyway?`,"Yes, Complete Anyway",()=>{he(t)},!0);return}if(n.scoringMode==="race"){const a=[],r=n.pointsPerMatch;if(t.matches.forEach((d,i)=>{const l=document.getElementById(`score-${e}-${i}-1`),c=document.getElementById(`score-${e}-${i}-2`),u=parseInt(l==null?void 0:l.value)||0,m=parseInt(c==null?void 0:c.value)||0;u<r&&m<r&&a.push(ve(d.court))}),a.length>0){const d=a.join(", ");H("Low Scores Detected",`On ${d}, neither team reached the target of ${r}. Is this correct?`,"Yes, Complete Round",()=>{he(t)},!0);return}}he(t)}function he(e){const t=n.schedule.findIndex(i=>i===e);nt().forEach((i,l)=>{const c=n.leaderboard.find(u=>u.id===i.id);c&&(c.previousRank=l+1)}),e.matches.forEach((i,l)=>{const c=document.getElementById(`score-${t}-${l}-1`),u=document.getElementById(`score-${t}-${l}-2`),m=parseInt(c==null?void 0:c.value)||0,f=parseInt(u==null?void 0:u.value)||0;i.score1=m,i.score2=f;const h=m===f,p=m>f,y=f>m;i.team1[1]?(X(i.team1[0].id,m,f,p,h,i.team1[1].id),X(i.team1[1].id,m,f,p,h,i.team1[0].id),X(i.team2[0].id,f,m,y,h,i.team2[1].id),X(i.team2[1].id,f,m,y,h,i.team2[0].id)):(X(i.team1[0].id,m,f,p,h,null),X(i.team2[0].id,f,m,y,h,null))});const s=document.querySelector(".complete-round-btn");if(s&&(s.classList.add("completing"),s.textContent="✓ Completing..."),pe(),e.completed=!0,e.byes&&e.byes.length>0&&e.byes.forEach(i=>{const l=n.leaderboard.find(c=>c.id===i.id);l&&(l.byeCount=(l.byeCount||0)+1)}),n.manualByes=[],n.currentRound++,n.format==="americano"&&n.allRounds&&n.currentRound<=n.allRounds.length){const i={...n.allRounds[n.currentRound-1]};n.schedule.push(i)}else if(n.format==="team"&&n.allRounds&&n.currentRound<=n.allRounds.length){const i={...n.allRounds[n.currentRound-1]};n.schedule.push(i)}else if(n.format==="teamMexicano"){if(n.currentRound<=20){const i=dn();i.matches.length>0&&n.schedule.push(i)}}else if(n.format==="mexicano"&&n.currentRound<=20){const i=un(n.leaderboard);i.matches.length>0&&n.schedule.push(i)}j(),U(),S();const a=document.getElementById(`round-${t}`);a&&(a.classList.add("complete-flash"),setTimeout(()=>a.classList.remove("complete-flash"),1e3));const r=e.number,d=n.schedule.length>t+1;C(d?`✓ Round ${r} complete! Round ${r+1} ready`:`✓ Round ${r} complete!`),setTimeout(()=>{const i=n.schedule.length-1,l=document.getElementById(`round-${i}`);l&&(l.classList.add("animate-in","highlight"),l.scrollIntoView({behavior:"smooth",block:"start"}),setTimeout(()=>{l.classList.remove("animate-in","highlight")},1600))},100)}function yt(e){const t=n.schedule[e];if(!(!t||!t.completed||n.schedule.length>e+1&&!confirm(`Editing Round ${e+1} will remove ${n.schedule.length-e-1} subsequent round(s). Continue?`))){pe();for(let s=e;s<n.schedule.length;s++){const a=n.schedule[s];a.completed&&a.matches.forEach(r=>{r.team1[1]?(Q(r.team1[0].id,r.score1||0,r.score2||0,r.score1>r.score2,r.score1===r.score2),Q(r.team1[1].id,r.score1||0,r.score2||0,r.score1>r.score2,r.score1===r.score2),Q(r.team2[0].id,r.score2||0,r.score1||0,r.score2>r.score1,r.score1===r.score2),Q(r.team2[1].id,r.score2||0,r.score1||0,r.score2>r.score1,r.score1===r.score2)):(Q(r.team1[0].id,r.score1||0,r.score2||0,r.score1>r.score2,r.score1===r.score2),Q(r.team2[0].id,r.score2||0,r.score1||0,r.score2>r.score1,r.score1===r.score2))})}n.schedule=n.schedule.slice(0,e+1),t.completed=!1,n.currentRound=e,j(),U(),S(),C(`Editing Round ${e+1}`)}}const Be="padel_history_v1";function vn(){var s;const e=re(),t=Mt(),o={id:Date.now().toString(),savedAt:new Date().toISOString(),summary:{date:new Date().toISOString(),format:t.format,winner:((s=t.leaderboard[0])==null?void 0:s.name)||"Unknown",playerCount:t.players.length,roundCount:t.schedule.length},data:t};return e.unshift(o),e.length>20&&e.pop(),localStorage.setItem(Be,JSON.stringify(e)),o}function re(){try{const e=localStorage.getItem(Be);return e?JSON.parse(e):[]}catch(e){return console.error("Failed to parse history",e),[]}}function bn(e){H("Delete this tournament from history?","This action cannot be undone.","Delete",()=>{const o=re().filter(s=>s.id!==e);localStorage.setItem(Be,JSON.stringify(o)),gt(),C("Tournament deleted")},!0)}function xn(e){const o=re().find(s=>s.id===e);if(!o){C("Tournament details not found","error");return}H("Load this tournament?","This will overwrite the current tournament.","Load",()=>{try{Oe(o.data),U(),j(),S(),C("Tournament loaded successfully"),document.getElementById("scheduleSection").style.display="block",document.getElementById("leaderboardSection").style.display="block"}catch(s){console.error("Failed to load tournament",s),C("Error loading tournament","error")}},!1)}let me=[];function wn(){gt();const e=document.getElementById("historySearch");e&&e.addEventListener("input",t=>{const o=t.target.value.toLowerCase();Sn(o)})}function Sn(e){if(!e){$e(me);return}const t=me.filter(o=>{var u,m,f,h,p,y,v,b;const s=(((u=o.summary)==null?void 0:u.winner)||((f=(m=o.players)==null?void 0:m[0])==null?void 0:f.name)||"").toLowerCase(),a=(((h=o.summary)==null?void 0:h.format)||o.format||"").toLowerCase(),r=((p=o.summary)==null?void 0:p.date)||o.date||"",d=String(((y=o.summary)==null?void 0:y.playerCount)||((v=o.players)==null?void 0:v.length)||""),i=String(((b=o.summary)==null?void 0:b.roundCount)||""),c=new Date(r).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}).toLowerCase();return s.includes(e)||a.includes(e)||c.includes(e)||d.includes(e)||i.includes(e)});$e(t)}function gt(){me=re(),$e(me)}function $e(e){const t=document.getElementById("historyTableBody"),o=document.getElementById("historyEmptyStatePage");if(!(!t||!o)){if(t.innerHTML="",e.length===0){t.parentElement.style.display="none",o.innerHTML=`
    ...
    `,o.style.display="block";return}t.parentElement.style.display="table",o.style.display="none",window.deleteHistoryItem=bn,window.loadTournament=xn,window.downloadHistoryItem=Cn,t.innerHTML=e.map(s=>{var f,h,p;const a=s.summary?s.summary.date:s.date,r=s.summary?s.summary.format:s.format||"Unknown",d=s.summary?s.summary.winner:((h=(f=s.players)==null?void 0:f[0])==null?void 0:h.name)||"Unknown",i=s.summary?s.summary.playerCount:((p=s.players)==null?void 0:p.length)||0,l=new Date(a),c=l.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),u=l.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),m=!!s.data;return`
      ...
      `)}),$t();const e=Fe();Bt(),e.format.value=n.format,e.courts.value=n.courts,e.scoringMode.value=n.scoringMode,e.points.value=n.pointsPerMatch,e.courtFormat.value=n.courtFormat,e.maxRepeats.value=n.maxRepeats,e.pairingStrategy&&(e.pairingStrategy.value=n.pairingStrategy);const t=document.getElementById("rankingCriteria");t&&(t.value=n.rankingCriteria);const o=document.getElementById("strictStrategy");if(o&&(o.checked=n.strictStrategy||!1),We(),pn(F),Y(),n.schedule.length>0){e.scheduleSection.style.display="block",e.leaderboardSection.style.display="block";const s=document.getElementById("tournamentActionsSection");s&&(s.style.display="block"),U(),j(),fe()}Pn(e),oe(),Bn(),wn(),window.addEventListener("resize",et),kn(),q(),Ze(),F(),In(),$n()}function In(){document.addEventListener("click",e=>{const t=e.target.closest(".btn");if(!t)return;const o=t.getBoundingClientRect(),s=document.createElement("span");s.className="ripple",s.style.width=s.style.height=`${Math.max(o.width,o.height)}px`,s.style.left=`${e.clientX-o.left-s.offsetWidth/2}px`,s.style.top=`${e.clientY-o.top-s.offsetHeight/2}px`,t.appendChild(s),setTimeout(()=>s.remove(),600)})}function $n(){const e=document.querySelectorAll(".section-title, .card-header-basic h3, .card-header-advanced h3, .leaderboard-header h3, .players-header h3");e.forEach(o=>o.classList.add("animate-in"));const t=new IntersectionObserver(o=>{o.forEach(s=>{s.isIntersecting&&s.target.classList.add("animate-in")})},{threshold:.1});e.forEach(o=>t.observe(o))}function kn(){const e=document.getElementById("scrollTopBtn");e&&(window.addEventListener("scroll",()=>{window.scrollY>400?e.classList.add("visible"):e.classList.remove("visible")}),e.addEventListener("click",()=>{window.scrollTo({top:0,behavior:"smooth"})}))}function Pn(e){const t=document.getElementById("undoBtn");t&&(t.addEventListener("click",()=>{if(Pt())if(C("Undo successful"),e.format.value=n.format,Y(),U(),j(),q(),fe(),n.schedule.length>0){e.scheduleSection.style.display="block",e.leaderboardSection.style.display="block";const u=document.getElementById("tournamentActionsSection");u&&(u.style.display="block")}else{e.scheduleSection.style.display="none",e.leaderboardSection.style.display="none";const u=document.getElementById("tournamentActionsSection");u&&(u.style.display="none")}}),document.addEventListener("keydown",u=>{(u.ctrlKey||u.metaKey)&&u.key==="z"&&!u.shiftKey&&(u.preventDefault(),t.click())})),e.clearAllPlayersBtn&&e.clearAllPlayersBtn.addEventListener("click",()=>{Wt(()=>{Y(),J(),q()})}),e.importPlayersBtn.addEventListener("click",Qe),e.closeImportModal.addEventListener("click",de),e.cancelImportBtn.addEventListener("click",de),e.confirmImportBtn.addEventListener("click",()=>{const u=e.importTextarea.value,m=Vt(u);let f=`Added ${m.added} players.`;m.duplicates>0&&(f+=` Skipped ${m.duplicates} duplicates.`),m.hitLimit&&(f+=" Stopped at 24 max limit."),e.importStatus.textContent=f,Y(),m.added>0&&m.duplicates===0&&!m.hitLimit&&(setTimeout(de,1500),C(`Imported ${m.added} players`))}),e.confirmAddBtn.addEventListener("click",()=>{ze(e.playerNameInput.value)&&(e.playerNameInput.value="",e.playerNameInput.focus(),Y())}),e.playerNameInput.addEventListener("keydown",u=>{u.key==="Enter"&&ze(e.playerNameInput.value)&&(e.playerNameInput.value="",Y())}),e.format.addEventListener("change",()=>{n.format=e.format.value,q(),S(),n.schedule.length>0&&ce()}),e.courts.addEventListener("change",()=>{n.courts=parseInt(e.courts.value),S(),F(),n.schedule.length>0&&ce(),n.courtFormat==="custom"&&be()}),e.points.addEventListener("change",()=>{n.pointsPerMatch=parseInt(e.points.value),S(),F(),n.schedule.length>0&&U()}),e.scoringMode.addEventListener("change",()=>{n.scoringMode=e.scoringMode.value,Ze(),S(),F(),n.schedule.length>0&&U()});const o=document.getElementById("rankingCriteria");o&&o.addEventListener("change",()=>{n.rankingCriteria=o.value,at(),S()}),e.courtFormat.addEventListener("change",()=>{n.courtFormat=e.courtFormat.value,We(),S()}),e.courts.addEventListener("input",()=>{const m=e.courts.value;if(m==="")return;let f=parseInt(m)||1;f=Math.max(1,Math.min(50,f)),!n.isLocked&&(e.courts.value=f,n.courts=f,S(),n.courtFormat==="custom"&&be(),n.schedule.length>0&&ce())}),e.maxRepeats.addEventListener("change",u=>{const m=parseInt(u.target.value),f=n.maxRepeats;n.isLocked?(u.target.value=f,H("Change Matchup Setting?","The tournament is running. This change will affect how future rounds are generated.","Apply Change",()=>{n.maxRepeats=m,e.maxRepeats.value=m,S(),F(),C("Max Partner Repeats updated")},!0)):(n.maxRepeats=m,S(),F())});const s=document.getElementById("strictStrategy");s&&s.addEventListener("change",u=>{if(n.pairingStrategy==="optimal"){u.target.checked=!1,C("Strict Pattern is not available with Optimal pairing","info");return}const m=u.target.checked,f=n.strictStrategy;n.isLocked?(u.target.checked=!!f,H("Update Strict Mode?","The tournament is running. This change will affect how future rounds are generated.","Apply Change",()=>{n.strictStrategy=m,s.checked=m,S(),C("Strict Mode updated")},!0)):(n.strictStrategy=m,S())}),e.pairingStrategy&&e.pairingStrategy.addEventListener("change",u=>{const m=u.target.value,f=n.pairingStrategy;if(n.isLocked)u.target.value=f,H("Change Matchup Setting?","The tournament is running. This change will affect how future rounds are generated.","Apply Change",()=>{if(n.pairingStrategy=m,e.pairingStrategy.value=m,m==="optimal"){n.strictStrategy=!1;const h=document.getElementById("strictStrategy");h&&(h.checked=!1)}S(),q(),C("Pairing Strategy updated")},!0);else{if(n.pairingStrategy=m,m==="optimal"){n.strictStrategy=!1;const h=document.getElementById("strictStrategy");h&&(h.checked=!1)}S(),q()}}),e.addPartnerPairBtn.addEventListener("click",()=>{if(Je().length<2){C("Not enough available players to form a pair","error");return}Yt(),J(),q(),oe(),C("Fixed pair added","success")});const a=document.getElementById("helpFormat");a&&a.addEventListener("click",()=>{ne("Tournament Formats",`
        ...
        `)}),e.generateBtn.addEventListener("click",fn),e.printBtn.addEventListener("click",()=>window.print()),e.resetBtn.addEventListener("click",yn),e.gridColumns&&e.gridColumns.addEventListener("input",on),e.textSize&&e.textSize.addEventListener("input",()=>{n.textSize=parseInt(e.textSize.value),tt(),S()});const l=document.getElementById("factoryResetBtn");l&&l.addEventListener("click",()=>{H("⚠️ Factory Reset","This will clear the current tournament and reset the app. Your saved history will NOT be deleted. Are you sure?","Yes, Reset App",()=>{localStorage.removeItem("tournament-state"),window.location.reload()},!0)});const c=document.getElementById("roundScale");c&&c.addEventListener("input",sn)}function Bn(){document.addEventListener("click",e=>{const t=e.target.closest("[data-action]");if(!t)return;const o=t.dataset.action,s=t.dataset.id?Number(t.dataset.id):null,a=t.dataset.round?parseInt(t.dataset.round):null;switch(o){case"remove-player":s!==null&&(Ge(s),Y());break;case"toggle-player-list":Pe();break;case"remove-pair":s!==null&&(ke(s),J(),q(),oe());break;case"toggle-bye":s!==null&&pt(s);break;case"toggle-round":a!==null&&mt(a);break;case"complete-round":ft();break;case"edit-round":a!==null&&yt(a);break;case"toggle-visibility":ot();break;case"toggle-position":st();break;case"end-tournament":it(_e);break;case"toggle-toolbar":lt();break;case"export-data":dt();break;case"share-results":ct();break;case"add-late-player":ht();break}}),document.addEventListener("change",e=>{const t=e.target.closest("[data-action]");if(!t)return;const o=t.dataset.action,s=t.dataset.pairId?Number(t.dataset.pairId):null,a=t.dataset.which?parseInt(t.dataset.which):null;if(o==="update-partner"&&s!==null&&a!==null&&(Ke(s,a,Number(t.value)),J(),q(),oe()),o==="autofill-score"&&n.scoringMode==="race"){const r=parseInt(t.dataset.round),d=parseInt(t.dataset.match),i=parseInt(t.dataset.team),l=t.value;Ie(r,d,i,l)}}),document.addEventListener("input",e=>{e.target.classList.contains("score-input")&&e.target.value.length>2&&(e.target.value=e.target.value.slice(0,2))}),document.addEventListener("input",e=>{const t=e.target.closest('[data-action="autofill-score"]');if(!t||n.scoringMode==="race")return;const o=parseInt(t.dataset.round),s=parseInt(t.dataset.match),a=parseInt(t.dataset.team),r=t.value;Ie(o,s,a,r)})}function ht(){const e=n.format==="team"||n.format==="teamMexicano";Ye(e?"Add Late Team":"Add Late Player",e?"Enter new team name:":"Enter new player name:",t=>{if(t&&t.trim()){if(n.format==="americano"||n.format==="team"){if(!confirm("Adding a player/team mid-tournament will switch the remaining rounds to Mexicano (Dynamic) logic to accommodate the change. Continue?"))return;n.format="mexicano",n.allRounds=null,C("Switched to Mexicano format")}Ut(t.trim());const o=document.getElementById("playerCount");o&&(o.textContent=`(${n.players.length})`),j(),C(`Added ${t.trim()} to tournament`)}})}window.removePlayer=e=>{Ge(e),Y()};window.togglePlayerList=Pe;window.updatePreferredPair=(e,t,o)=>{Ke(e,t,o),J()};window.removePreferredPair=e=>{ke(e),J()};window.updateCustomCourtName=Tt;window.autoFillScore=Ie;window.toggleManualBye=pt;window.toggleRoundCollapse=mt;window.completeRound=ft;window.editRound=yt;window.toggleLeaderboardVisibility=ot;window.togglePositionChanges=st;window.updateRankingCriteria=at;window.updateSetupUI=q;window.endTournament=()=>it(_e);window.validateCourts=je;window.toggleToolbar=lt;window.exportTournamentData=dt;window.shareResults=ct;window.promptAddLatePlayer=ht;En();
