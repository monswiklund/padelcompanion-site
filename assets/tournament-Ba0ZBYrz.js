import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css              */const n={players:[],format:"americano",courts:2,scoringMode:"total",pointsPerMatch:24,rankingCriteria:"points",courtFormat:"court",customCourtNames:[],maxRepeats:99,pairingStrategy:"optimal",preferredPartners:[],manualByes:[],hideLeaderboard:!0,showPositionChanges:!0,gridColumns:0,textSize:100,isLocked:!1,schedule:[],currentRound:0,leaderboard:[],allRounds:null,maxCourts:2},V=[],je=20;function se(){const e=JSON.parse(JSON.stringify(n));V.push(e),V.length>je&&V.shift()}function Ue(){if(V.length===0)return!1;const e=V.pop();return Be(e),!0}function Ve(){return V.length>0}const Le="tournament-state";function v(){localStorage.setItem(Le,JSON.stringify({players:n.players,format:n.format,courts:n.courts,scoringMode:n.scoringMode,pointsPerMatch:n.pointsPerMatch,rankingCriteria:n.rankingCriteria,courtFormat:n.courtFormat,customCourtNames:n.customCourtNames,maxRepeats:n.maxRepeats,pairingStrategy:n.pairingStrategy,preferredPartners:n.preferredPartners,schedule:n.schedule,currentRound:n.currentRound,leaderboard:n.leaderboard,allRounds:n.allRounds,isLocked:n.isLocked,hideLeaderboard:n.hideLeaderboard,manualByes:n.manualByes,gridColumns:n.gridColumns,textSize:n.textSize}))}function Ye(){const e=localStorage.getItem(Le);if(!e)return!1;try{const t=JSON.parse(e);return n.players=Array.isArray(t.players)?t.players.slice(0,200):[],n.format=t.format||"americano",n.courts=Math.max(1,Math.min(50,t.courts||2)),n.scoringMode=t.scoringMode||"total",n.pointsPerMatch=Math.max(1,Math.min(999,t.pointsPerMatch||24)),n.rankingCriteria=t.rankingCriteria||"points",n.courtFormat=t.courtFormat||"court",n.customCourtNames=Array.isArray(t.customCourtNames)?t.customCourtNames.slice(0,50):[],n.maxRepeats=Math.max(0,Math.min(99,t.maxRepeats!==void 0?t.maxRepeats:99)),n.pairingStrategy=t.pairingStrategy||"optimal",n.preferredPartners=Array.isArray(t.preferredPartners)?t.preferredPartners.slice(0,100):[],n.schedule=Array.isArray(t.schedule)?t.schedule:[],n.currentRound=Math.max(0,Math.min(100,t.currentRound||0)),n.leaderboard=Array.isArray(t.leaderboard)?t.leaderboard:[],n.allRounds=t.allRounds||null,n.isLocked=t.isLocked||!1,n.hideLeaderboard=t.hideLeaderboard!==void 0?t.hideLeaderboard:!0,n.manualByes=Array.isArray(t.manualByes)?t.manualByes:[],n.gridColumns=Math.max(0,Math.min(10,t.gridColumns||0)),n.textSize=Math.max(50,Math.min(200,t.textSize||100)),!0}catch(t){return console.error("Failed to load tournament state:",t),!1}}function _e(){return JSON.parse(JSON.stringify(n))}function Be(e){e&&(Object.keys(n).forEach(t=>{e.hasOwnProperty(t)&&(n[t]=e[t])}),n.players=n.players||[],n.schedule=n.schedule||[],n.leaderboard=n.leaderboard||[],v())}function te(e){for(let t=e.length-1;t>0;t--){const s=Math.floor(Math.random()*(t+1));[e[t],e[s]]=[e[s],e[t]]}return e}function w(e,t=3e3){const s=document.querySelector(".toast");s&&s.remove();const o=document.createElement("div");o.className="toast",o.textContent=e,document.body.appendChild(o),setTimeout(()=>o.classList.add("visible"),10),setTimeout(()=>{o.classList.remove("visible"),setTimeout(()=>o.remove(),300)},t)}function ae(){return Date.now()+Math.random()}let x,M,N,F,Y=[],ce,J=!1;const Ce=["#f44336","#e91e63","#9c27b0","#673ab7","#3f51b5","#2196f3","#03a9f4","#00bcd4","#009688","#4caf50","#8bc34a","#cddc39","#ffeb3b","#ffc107","#ff9800","#ff5722"];function Se(e,t){return Math.floor(Math.random()*(t-e+1)+e)}function Ge(){this.x=Math.random()*N,this.y=Math.random()*F-F,this.r=Se(10,30),this.d=Math.random()*150+10,this.color=Ce[Se(0,Ce.length-1)],this.tilt=Math.floor(Math.random()*10)-10,this.tiltAngleIncremental=Math.random()*.07+.05,this.tiltAngle=0,this.draw=function(){return M.beginPath(),M.lineWidth=this.r/2,M.strokeStyle=this.color,M.moveTo(this.x+this.tilt+this.r/4,this.y),M.lineTo(this.x+this.tilt,this.y+this.tilt+this.r/4),M.stroke()}}function Pe(){if(J){M.clearRect(0,0,N,F);for(let e=0;e<Y.length;e++)Y[e].draw();Xe(),ce=requestAnimationFrame(Pe)}}function Xe(){for(let e=0;e<Y.length;e++){const t=Y[e];t.tiltAngle+=t.tiltAngleIncremental,t.y+=(Math.cos(t.d)+3+t.r/2)/2,t.tilt=Math.sin(t.tiltAngle-e/3)*15,(t.x>N+20||t.x<-20||t.y>F)&&J&&(t.x=Math.random()*N,t.y=-10,t.tilt=Math.floor(Math.random()*10)-10)}}function Je(){if(!J){x||(x=document.createElement("canvas"),x.id="confetti-canvas",x.style.position="fixed",x.style.top="0",x.style.left="0",x.style.width="100%",x.style.height="100%",x.style.pointerEvents="none",x.style.zIndex="9999",document.body.appendChild(x),M=x.getContext("2d")),N=window.innerWidth,F=window.innerHeight,x.width=N,x.height=F,window.addEventListener("resize",()=>{N=window.innerWidth,F=window.innerHeight,x.width=N,x.height=F}),J=!0,Y=[];for(let e=0;e<150;e++)Y.push(new Ge);Pe()}}function Ke(){J=!1,M&&M.clearRect(0,0,N,F),ce&&cancelAnimationFrame(ce),x&&x.remove(),x=null}function Qe(){Je(),setTimeout(Ke,5e3)}function k(e,t,s="Confirm",o,a=!1,r=null,d=null){const i=document.querySelector(".confirm-modal");i&&i.remove();const l=document.createElement("div");l.className="modal-overlay confirm-modal",l.style.display="flex";const m=a?"btn btn-danger":"btn btn-primary";l.innerHTML=`
  ...
  `,document.body.appendChild(l),setTimeout(()=>l.classList.add("visible"),10);const u=l.querySelector(".modal");u&&u.addEventListener("click",p=>p.stopPropagation());const c=l.querySelector("#modalCancelBtn"),y=l.querySelector("#modalConfirmBtn"),h=l.querySelector("#modalSecondaryBtn"),g=()=>l.remove();c&&c.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation(),g()}),y&&y.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation(),g(),o()}),h&&d&&h.addEventListener("click",p=>{p.preventDefault(),p.stopPropagation(),g(),d()}),l.addEventListener("click",p=>{p.target===l&&g()})}function Ie(e,t,s){const o=document.querySelector(".input-modal");o&&o.remove();const a=document.createElement("div");a.className="modal-overlay input-modal",a.style.display="flex",a.innerHTML=`
    <div class="modal" style="max-width: 400px; text-align: center;">
      <div class="modal-header">
        <h3>${e}</h3>
      </div>
  ...
  `).join("")}function ct(e,t){n.customCourtNames[e]=t||`Court ${e+1}`,v()}function O(){const e=C();e.playerList.innerHTML=n.players.map((t,s)=>`
  ...
  `).join(""),e.playerCount.textContent=`(${n.players.length})`,e.generateBtn.disabled=n.players.length<4,n.players.length>=4?(e.playersHint.textContent=`${n.players.length} players ready`,e.playersHint.style.color="var(--success)"):(e.playersHint.textContent=`Add at least ${4-n.players.length} more player${4-n.players.length>1?"s":""}`,e.playersHint.style.color=""),K(),yt(),pt(),ke()}function ut(){const e=C();e.playerInputRow.style.display="flex",e.addPlayerBtn.style.display="none",e.playerNameInput.focus()}function xe(){const e=C();e.playerInputRow.style.display="none",e.addPlayerBtn.style.display="block",e.playerNameInput.value=""}function mt(){const e=document.getElementById("playerListWrapper"),t=document.getElementById("expandPlayersBtn");e.classList.contains("expanded")?(e.classList.remove("expanded"),t.innerHTML=`Show All Players (${n.players.length}) ▼`):(e.classList.add("expanded"),t.innerHTML="Show Less ▲")}function pt(){const e=document.getElementById("expandPlayersBtn"),t=document.getElementById("playerListWrapper");e&&!(t!=null&&t.classList.contains("expanded"))&&(e.innerHTML=`Show All Players (${n.players.length}) ▼`)}function yt(){const e=C(),t=new Set;n.preferredPartners.forEach(o=>{t.add(o.player1Id),t.add(o.player2Id)});const s=n.players.filter(o=>!t.has(o.id));e.addPartnerPairBtn.disabled=s.length<2}function K(){const e=C(),t=s=>{const o=new Set;return n.preferredPartners.forEach(a=>{a.id!==s&&(o.add(a.player1Id),o.add(a.player2Id))}),o};e.preferredPartnersList.innerHTML=n.preferredPartners.map(s=>{const o=t(s.id),a=n.players.filter(i=>i.id===s.player1Id||i.id===s.player2Id||!o.has(i.id)),r=a.filter(i=>i.id!==s.player2Id||i.id===s.player1Id),d=a.filter(i=>i.id!==s.player1Id||i.id===s.player2Id);return`
...
`,t.schedule.forEach(l=>{l.completed&&l.matches.forEach(m=>{const u=m.team1.map(h=>h.name).join(" & "),c=m.team2.map(h=>h.name).join(" & ");let y=`Court ${m.court}`;t.courtFormat==="custom"&&t.customCourtNames&&t.customCourtNames[m.court-1]?y=t.customCourtNames[m.court-1]:t.courtFormat==="number"&&(y=`${m.court}`),a+=`Round ${l.number},"${y}","${u}",${m.score1},${m.score2},"${c}"
...
`}),o+=`
Full results: https://padelcompanion.se/tournament/`;try{await navigator.clipboard.writeText(o),w("Results copied to clipboard")}catch(d){console.error("Failed to copy: ",d),w("Failed to copy results","error")}}const pe="padel_history_v1";function Dt(){var o;const e=Z(),t=_e(),s={id:Date.now().toString(),savedAt:new Date().toISOString(),summary:{date:new Date().toISOString(),format:t.format,winner:((o=t.leaderboard[0])==null?void 0:o.name)||"Unknown",playerCount:t.players.length,roundCount:t.schedule.length},data:t};return e.unshift(s),e.length>20&&e.pop(),localStorage.setItem(pe,JSON.stringify(e)),s}function Z(){try{const e=localStorage.getItem(pe);return e?JSON.parse(e):[]}catch(e){return console.error("Failed to parse history",e),[]}}function zt(e){k("Delete this tournament from history?","This action cannot be undone.","Delete",()=>{const s=Z().filter(o=>o.id!==e);localStorage.setItem(pe,JSON.stringify(s)),Fe(),w("Tournament deleted")},!0)}function Ht(e){const s=Z().find(o=>o.id===e);if(!s){w("Tournament details not found","error");return}k("Load this tournament?","This will overwrite the current tournament.","Load",()=>{try{Be(s.data),z(),T(),v(),w("Tournament loaded successfully"),document.getElementById("scheduleSection").style.display="block",document.getElementById("leaderboardSection").style.display="block"}catch(o){console.error("Failed to load tournament",o),w("Error loading tournament","error")}},!1)}let oe=[];function qt(){Fe();const e=document.getElementById("historySearch");e&&e.addEventListener("input",t=>{const s=t.target.value.toLowerCase();Ot(s)})}function Ot(e){if(!e){me(oe);return}const t=oe.filter(s=>{var u,c,y,h,g,p,b,R;const o=(((u=s.summary)==null?void 0:u.winner)||((y=(c=s.players)==null?void 0:c[0])==null?void 0:y.name)||"").toLowerCase(),a=(((h=s.summary)==null?void 0:h.format)||s.format||"").toLowerCase(),r=((g=s.summary)==null?void 0:g.date)||s.date||"",d=String(((p=s.summary)==null?void 0:p.playerCount)||((b=s.players)==null?void 0:b.length)||""),i=String(((R=s.summary)==null?void 0:R.roundCount)||""),m=new Date(r).toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}).toLowerCase();return o.includes(e)||a.includes(e)||m.includes(e)||d.includes(e)||i.includes(e)});me(t)}function Fe(){oe=Z(),me(oe)}function me(e){const t=document.getElementById("historyTableBody"),s=document.getElementById("historyEmptyStatePage");if(!(!t||!s)){if(t.innerHTML="",e.length===0){t.parentElement.style.display="none",s.style.display="block";return}t.parentElement.style.display="table",s.style.display="none",window.deleteHistoryItem=zt,window.loadTournament=Ht,window.downloadHistoryItem=Wt,t.innerHTML=e.map(o=>{var y,h,g;const a=o.summary?o.summary.date:o.date,r=o.summary?o.summary.format:o.format||"Unknown",d=o.summary?o.summary.winner:((h=(y=o.players)==null?void 0:y[0])==null?void 0:h.name)||"Unknown",i=o.summary?o.summary.playerCount:((g=o.players)==null?void 0:g.length)||0,l=new Date(a),m=l.toLocaleDateString(void 0,{month:"short",day:"numeric",year:"numeric"}),u=l.toLocaleTimeString(void 0,{hour:"2-digit",minute:"2-digit"}),c=!!o.data;return`
      <tr>
        <td>
